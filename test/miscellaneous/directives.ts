...
describe('Miscellaneous - Directives', () => {
    ...
    fail('strict directive after legacy octal ', { source:  '"\\1;" "use strict";', directives: true});
    fail('strict directive after legacy octal in function body', { source:  '"use strict"; function f(){"\\1";}', directives: true});
    ...
    fail('strict directive before legacy octal', { source:  '"\\1;"', module: true});
    ...
    fail('invalid paragraph separators after Unicode \\ua', { source:  '"random\\ua\u2029newline"', directives: true, module: true});
    ...
    fail("catches invalid space after Unicode \\u0", { source:  "'random\\u0 foo'", directives: true});
    fail("catches invalid space after Unicode \\ua", { source:  "'random\\ua foo'", directives: true});
    ...
    fail("catches invalid space after Unicode \\u000", { source:  "'random\\u000 foo'", directives: true});
    fail("catches invalid space after Unicode \\u00a", { source:  "'random\\u00a foo'", directives: true});
    fail("catches invalid space after Unicode \\u{", { source:  "'random\\u{ foo'"});
    ...
    fail("catches invalid x after Unicode \\u", { source:  "'random\\ux foo'", directives: true});
    ...
    fail("catches invalid x after Unicode \\u000", { source:  "'random\\u000x foo'", directives: true});
    fail("catches invalid x after Unicode \\u00a", { source:  "'random\\u00ax foo'", directives: true});
    ...
    fail("catches invalid X after Unicode \\u0", { source:  "'random\\u0X foo'"});
    fail("catches invalid X after Unicode \\ua", { source:  "'random\\uaX foo'"});
    fail("catches invalid X after Unicode \\u00", { source:  "'random\\u00X foo'", directives: true});
    fail("catches invalid X after Unicode \\u0a", { source:  "'random\\u0aX foo'", directives: true});
    fail("catches invalid X after Unicode \\u000", { source:  "'random\\u000X foo'", directives: true});
    ...
    fail("catches invalid u after Unicode \\u0", { source:  "'random\\u0u foo'", directives: true});
    fail("catches invalid u after Unicode \\ua", { source:  "'random\\uau foo'", directives: true});
    fail("catches invalid u after Unicode \\u00", { source:  "'random\\u00u foo'"});
    fail("catches invalid u after Unicode \\u0a", { source:  "'random\\u0au foo'", directives: true});
    ...
    fail("catches invalid u after Unicode \\u{", { source:  "'random\\u{u foo'", directives: true});
    ...
    fail("catches invalid { after Unicode \\u0a", { source:  "'random\\u0a{ foo'"});
    fail("catches invalid { after Unicode \\u000", { source:  "'random\\u000{ foo'"});
    fail("catches invalid { after Unicode \\u000", { source:  "'random\\u000{ foo'", module: true, directives: true});
    fail("catches invalid { after Unicode \\u00a", { source:  "'random\\u00a{ foo'", directives: true});
    fail("catches invalid { after Unicode \\u{", { source:  "'random\\u{{ foo'", directives: true});
    fail("catches invalid { after Unicode \\u{0", { source:  "'random\\u{0{ foo'"});
    fail("catches invalid { after Unicode \\u{a", { source:  "'random\\u{a{ foo'"});
    fail("catches invalid } after ASCII \\x", { source:  "'random\\x} foo'"});
    fail("catches invalid } after ASCII \\x0", { source:  "'random\\x0} foo'"});
    fail("catches invalid } after Unicode \\u", { source:  "'random\\u} foo'"});
    fail("catches invalid } after Unicode \\u0", { source:  "'random\\u0} foo'", directives: true});
    fail("catches invalid } after Unicode \\ua", { source:  "'random\\ua} foo'", directives: true});
    fail("catches invalid } after Unicode \\u00", { source:  "'random\\u00} foo'", directives: true});
    fail("catches invalid } after Unicode \\u0a", { source:  "'random\\u0a} foo'", directives: true});
    fail("catches invalid } after Unicode \\u000", { source:  "'random\\u000} foo'", directives: true});
    fail("catches invalid } after Unicode \\u00a", { source:  "'random\\u00a} foo'", directives: true});
    fail("catches invalid } after Unicode \\u00a", { source:  "'random\\u00a} foo'", module: true });
    fail("catches invalid } after Unicode \\u{", { source:  "'random\\u{} foo'", directives: true});
    fail("catches invalid } after Unicode \\u{", { source:  "'random\\u{} foo'", module: true});
