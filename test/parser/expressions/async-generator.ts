...
describe('Expressions - Async Generator Functions', () => {
  const inValids: Array<[string, Context]> = [
    ...
    ['(async function *foo() { var await; });', Context.Strict],

    ['(async function *foo() { var await; });', Context.Empty],
    ['(async function *foo() { void await; });', Context.Empty],
    ...
    ['(async function*([...x, y]) {})', Context.Empty],
    ['(async function*([...x, y] = [1, 2, 3]) {})', Context.Empty],
    ['(async function* h([...{ x } = []]) {})', Context.Empty],
    ['(async function* h([...{ x } = []] = []) {})', Context.Empty],
    ['(async function*() { await: 1; });', Context.Empty],
    ['(async function *foo(...a,) {})', Context.Empty],
    ['(async function *foo([...[ x ] = []])', Context.Empty],
    ['(async function *foo([...{ x } = []]) {})', Context.Empty],
    ['(async function *foo([...{ x } = []] = []) {})', Context.Empty],
    ['(async function *foo([...x, y]) {})', Context.Empty],
    ['(async function *foo([...[x], y] = [1, 2, 3]) {})', Context.Empty],
    ['(async function *foo([...{ x } = []] = [])', Context.Empty],
    ['"use strict"; (async function* arguments() { });', Context.Empty],
    ['(async function*(a = super()) { });', Context.Empty],
    ['0, async function* g(...a,) {};', Context.Empty],
    ['(async function* yield() { });', Context.Empty],
    ['(async function* g() { var await; });', Context.Empty],
    ['(async function* g() { var await; });', Context.Empty],
    ['(async function* g() { var yield; });', Context.Empty],
    ['(async function* g() { void await; });', Context.Module],
    ['(async function* g() { var yield; });', Context.Module],
    ['(async function* g() { void yield; });', Context.Module],
    ['(async function* g() { yield: ; });', Context.Module],
    ['0, async function* g(...x = []) {}', Context.Module],
    [
      `"use strict";
    async function *g() {
    return {
