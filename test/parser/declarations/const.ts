...
describe('Declarations - Const', () => {
  fail('Declarations - Let (fail)', [
    ...
    ['for (const x = y, {z});', Context.OptionsDisableWebCompat],
    ['for (const {x}, y);', Context.OptionsDisableWebCompat],
    ['for (const {x:y});', Context.OptionsDisableWebCompat],
    ['for (const {x=y});', Context.OptionsDisableWebCompat],
    ['for (const {x:y=z});', Context.OptionsDisableWebCompat],
    ['for (const {x:y=z} = obj, {a:b=c});', Context.OptionsDisableWebCompat],
    ['for (const {x:y=z}, {a:b=c} of obj);', Context.OptionsDisableWebCompat],
    ...
    ['export const {[x]: y = z};', Context.Module],
    ['const a, [...x] = y', Context.OptionsDisableWebCompat],
    ['const foo;', Context.Module],
    ['const foo, bar = x;', Context.OptionsDisableWebCompat],
    ['const foo =x, bar;', Context.OptionsDisableWebCompat],
