...
describe('TC262 - explicit', () => {
    ...
    it('should parse "if (1) /  foo/;"', () => {
      expect(parseScript(`switch(a) { case 1: {}
      /foo/ }`, {
          ranges: true,
          raw: true,
          locations: true
    ...
    it('should parse ""use strict"; obect.static();', () => {
      expect(parseScript('"use strict"; object.static();', {
          ranges: true,
          raw: true,
          locations: true
      })).to.eql({
   ...
   it('should parse "for(var x = 0, y = 1;;);"', () => {
    ...
    it('should parse "try { } catch (eval) { }"', () => {
      expect(parseScript('try { } catch (eval) { }', {
          ranges: true,
          raw: true,
          locations: true
      })).to.eql({
    ...
    it('should parse "var hi = function arguments() { };"', () => {
      expect(parseScript('var hi = function arguments() { };', {
          ranges: true,
          raw: true,
          locations: true
      })).to.eql({
    ...
    it('should parse "var x /* comment */;"', () => {
      expect(parseScript('var x /* comment */;', {
          ranges: true,
          raw: true,
          locations: true
      })).to.eql({
    ...
    it('should parse "if (1) /  foo/;"', () => {
      expect(parseScript(`{ throw error// Comment
        error; }`, {
          ranges: true,
          raw: true,
          locations: true
    ...
    it('should parse "x = { get false() {} }"', () => {
      expect(parseScript('x = { get false() {} }', {
          ranges: true,
          raw: true,
          locations: true
      })).to.eql({
    ...
    it('should parse "call(1); run(2);"', () => {
      expect(parseScript(`call(1); run(2);`, {
          ranges: true,
          raw: true,
          locations: true
      })).to.eql({
    ...
    it('should parse "var source = T\\u200C = [];"', () => {
      expect(parseScript(`var source = 'T\\u200C = []';`, {
          ranges: true,
          raw: true,
          locations: true
      })).to.eql({
    ...
    it.skip('should parse "var source = "\\u2163\u2161 = []";"', () => {
    ...
    it('should parse ""Hello\\02World""', () => {
      expect(parseScript(`"Hello\\02World"`, {
          ranges: true,
          raw: true,
          locations: true
      })).to.eql({
