...
describe('TC39 - Parenthesized', () => {
  ...
  it('should fail on "c = ([b]) = b;"', () => {
    expect(() => {
        parseScript('c = ([b]) = b;')
    }).to.throw('');
  });

  it('should fail on "([{constructor(){}}] = b);"', () => {
    expect(() => {
        parseScript('([{constructor(){}}] = b);')
    }).to.throw('');
  });
  ...
  it('should parse "({b} = b);"', () => {
    ...
    it('should parse "({a, b} = {a: 1, b: 2});"', () => {
      expect(parseScript(`({a, b} = {a: 1, b: 2});`, {
          raw: true,
          ranges: true,
          locations: true
      })).to.eql({
    ...
    it('should parse "[(a) = 0] = 1"', () => {
        expect(parseScript(`[(a) = 0] = 1`, {
            raw: true,
            ranges: true,
            locations: true
        })).to.eql({
