...
var await;
    ...
    it.skip('should parse arrow function destructed', () => {
    ...
    it('should parse await expression class method', () => {
    ...
    it('should parse async await identifier math', () => {
    ...
    it('should parse async await named object method', () => {
    ...
    it('should parse async await object method param', () => {
    ...
    it('should parse params with trailing comma', () => {
        expect(parseScript(`ref = (a, b = 39,) => {};`, {
            ranges: true,
            locations: true,
            raw: true
        })).to.eql({
    ...
    it('should parse arrow parameters with binding identifiers concise body', () => {
    ...
    it('should parse arrow parameters cover rest line terminator concise body', () => {
      expect(parseScript(`var af = (...x) =>
      { return x.length; };`, {
          ranges: true,
          locations: true,
          raw: true
    ...
    it('should parse arrow parameters with binding identifiers', () => {
      expect(parseScript(`var af = arguments => arguments;`, {
          ranges: true,
          locations: true,
          raw: true
      })).to.eql({
