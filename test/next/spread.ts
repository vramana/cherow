...
describe('Next - Spread', () => {
    ...
    fail('function test({...{a}}) {}', { source: `function test({...{a}}) {}`, next: true });
    fail('function test({...{}}) {}', { source: `function test({...{}}) {}`, next: true });
    fail('var {...x = 1} = {}', { source: `var {...x = 1} = {}`, next: true });
    fail('var {...[]} = {}', { source: `var {...[]} = {}`, next: true });
    fail('function test({...[]}) {}', { source: `function test({...[]}) {}`, next: true });
