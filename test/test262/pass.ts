...
describe('test262 tests', () => parserTest262({
    ...
    ignore: [
        ...
        'test/language/expressions/class/fields*.js',
        ...
        'test/language/expressions/exponentiation/exp-operator-syntax-error-logical-not-unary-expression-base.js',
        'test/language/expressions/exponentiation/exp-operator-syntax-error-delete-unary-expression-base.js',
        ...
        'test/language/statements/forvlet-identifier-with-newline.js',
        ...
        'test/language/statements/for-in/scope*.js',
