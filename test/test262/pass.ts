...
describe('test262 tests', () => parserTest262({
    ...
    ignore: [
        ...
        /* The majority of whitelisted tests actually pass. There exist an bug in the
           Test262 code. */
        ...
        'test/language/literals/numeric/numeric-separator-literal-nzd-nsl-dds-leading-zero-err.js',
