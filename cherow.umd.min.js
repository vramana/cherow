(function (global, factory) {
          ...
          if (ch === 92) {
              ...
              if (ch >= 128) {
                  ...
                  if (code >= 0)
                      ...
                      reportInvalidEscapeError(state, context, code);
                  ch = state.lastChar;
              }
          }
  ...
  function reportInvalidEscapeError(state, context, code) {
      switch (code) {
          case -2:
              report(state, context & 65536 ?
                  134 :
                  33);
          case -3:
              report(state, 32);
          ...
          if (ch === 36) {
              ...
              if (ch >= 128) {
                  ...
                  if (code >= 0) {
                      ...
                      reportInvalidEscapeError(state, context | 65536, code);
                  }
                  ch = state.lastChar;
              }
          }
  ...
  function parseLeftHandSideExpression(state, context, start) {
      ...
      return parseCallExpression(state, (context | 8192) ^ 8192, start, expr);
  }
