...
module.exports = (results, whitelist) => {
  ...
  const goodnews = [
    ...
    summary.allowed.failure.length + ' invalid programs produced a parsing error',
    ...
    summary.allowed.falseNegative.length +
      ...
      ' (and allowed by the whitelist file)',
    summary.skipped.length + ' programs were skipped'
  ];
  const badnews = [];
  ...
  void [
    {
      ...
      label: 'valid programs parsed without error' + ' (in violation of the whitelist file)'
    },
    {
      tests: summary.disallowed.failure,
      label: 'invalid programs produced a parsing error' + ' (in violation of the whitelist file)'
    },
    {
      tests: summary.disallowed.falsePositive,
      label:
        'invalid programs did not produce a parsing error' + ' (without a corresponding entry in the whitelist file)'
    },
    {
      tests: summary.disallowed.falseNegative,
      label: 'valid programs produced a parsing error' + ' (without a corresponding entry in the whitelist file)'
    },
    {
