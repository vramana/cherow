...
export const CharTypes = [
  ...
  CharFlags.IdentifierPart |
    CharFlags.NoKeywordCandidate |
    CharFlags.Decimal |
    CharFlags.Binary |
    CharFlags.Octal /* 0x30 0 */,
  CharFlags.IdentifierPart |
    CharFlags.NoKeywordCandidate |
    CharFlags.Decimal |
    CharFlags.Binary |
    CharFlags.Octal /* 0x31 1 */,
  ...
  CharFlags.IdentifierPart |
    CharFlags.NoKeywordCandidate |
    CharFlags.Decimal |
    CharFlags.NonOctalDecimalDigit /* 0x38 8 */,
  CharFlags.IdentifierPart |
    CharFlags.NoKeywordCandidate |
    CharFlags.Decimal |
    CharFlags.NonOctalDecimalDigit /* 0x39 9 */,
  ...
  CharFlags.StringTerminator | CharFlags.NeedSlowPath | CharFlags.IdentifierStart /* 0x5C   */,
