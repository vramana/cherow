...
export const CharTypes = [
  ...
  CharFlags.IdentifierPart | CharFlags.Decimal | CharFlags.Binary | CharFlags.Octal /* 0x30 0 */,
  CharFlags.IdentifierPart | CharFlags.Decimal | CharFlags.Binary | CharFlags.Octal /* 0x31 1 */,
  CharFlags.IdentifierPart | CharFlags.Decimal | CharFlags.Octal /* 0x32 2 */,
  CharFlags.IdentifierPart | CharFlags.Decimal | CharFlags.Octal /* 0x33 3 */,
  CharFlags.IdentifierPart | CharFlags.Decimal | CharFlags.Octal /* 0x34 4 */,
  CharFlags.IdentifierPart | CharFlags.Decimal | CharFlags.Octal /* 0x35 5 */,
  CharFlags.IdentifierPart | CharFlags.Decimal | CharFlags.Octal /* 0x36 6 */,
  CharFlags.IdentifierPart | CharFlags.Decimal | CharFlags.Octal /* 0x37 7 */,
  CharFlags.IdentifierPart | CharFlags.Decimal | CharFlags.NonOctalDecimalDigit /* 0x38 8 */,
  CharFlags.IdentifierPart | CharFlags.Decimal | CharFlags.NonOctalDecimalDigit /* 0x39 9 */,
