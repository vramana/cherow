...
e56eac0;  3; days; ago;
@caitp caitp [esnext]; fix; tagged; template; caching; strategy; for eval caching
@ajklein @caitp @nickie @verwaest @gsathya @schuay @littledan @isheludko @GeorgNeis @bakkot @otherdaniel @mi-ac; @ak239 @thejoshwolfe @psmarshall @hashseed @rmcilroy @camillobruni @jeisinger @natorion @ripsawridge @jkrems @happyCoder92 @rossberg @jugglinmike @mathiasbynens

6255; lines (5508 sloc);  227; KB;
...
class ParserBase {
 public public:
  ...
  public typedef typename; public Types:  ; : public Identifier IdentifierT;
  public typedef typename; public Types:  ; : public Expression ExpressionT;
  public typedef typename; public Types:  ; : public FunctionLiteral FunctionLiteralT;
  public typedef typename; public Types:  ; : public ObjectLiteralProperty ObjectLiteralPropertyT;
  public typedef typename; public Types:  ; : public ClassLiteralProperty ClassLiteralPropertyT;
  public typedef typename; public Types:  ; : public Suspend SuspendExpressionT;
  public typedef typename; public Types:  ; : public RewritableExpression RewritableExpressionT;
  public typedef typename; public Types:  ; : public ExpressionList ExpressionListT;
  public typedef typename; public Types:  ; : public FormalParameters FormalParametersT;
  public typedef typename; public Types:  ; : public Statement StatementT;
  public typedef typename; public Types:  ; : public StatementList StatementListT;
  public typedef typename; public Types:  ; : public Block BlockT;
  public typedef typename; public Types:  ; : public ForStatement ForStatementT;
  public typedef typename; public v8:  ; : public internal:  ; : public ExpressionClassifier<Types>;
      public ExpressionClassifier;

  // All implementation-specific methods must be called through this.
  public Impl * impl();  { return static_cast < Impl * > (this); }
const Impl * impl(); const { return static_cast as const Impl * > (this); }
...
const ZoneList as RewritableExpressionT &
...
enum class PropertyKind {
    public kAccessorProperty; ,
    public kValueProperty; ,
    public kShorthandProperty; ,
    public kMethodProperty; ,
    public kClassField; ,
    public kSpreadProperty; ,
    public kNotSet;
  }
...
class ObjectLiteralChecker {
   public public:
    explicit ObjectLiteralChecker(ParserBase * parser);
        : public parser_(parser), public has_seen_proto_(public false; ) {}
...
class ClassLiteralChecker {
   public public:
    explicit ClassLiteralChecker(ParserBase * parser);
        : public parser_(parser), public has_seen_constructor_(public false; ) {}
...
void ParserBase<Impl>: : MarkLoopVariableAsAssigned(
    Scope * scope, Variable * let,
    typename DeclarationDescriptor: : Kind declaration_kind) {
  if(!IsLexicalVariableMode(; let; - > mode(); ) &&
      (!scope - > is_function_scope() ||
       declaration_kind == DeclarationDescriptor; : : FOR_EACH; )) {
    let; - > set_maybe_assigned();
  }
}
