System.register(['cherow'], function (exports, module) {
  'use strict';
  var report, tokenDesc, tolerant, Scanner, constructError, errorMessages, Parser, getLocation, consume, finishNode, expect, consumeSemicolon, nextToken, isValidIdentifierPart;
  return {
    setters: [function (module) {
      report = module.report;
      tokenDesc = module.tokenDesc;
      tolerant = module.tolerant;
      Scanner = module.Scanner;
      constructError = module.constructError;
      errorMessages = module.errorMessages;
      Parser = module.Parser;
      getLocation = module.getLocation;
      consume = module.consume;
      finishNode = module.finishNode;
      expect = module.expect;
      consumeSemicolon = module.consumeSemicolon;
      nextToken = module.nextToken;
      isValidIdentifierPart = module.isValidIdentifierPart;
    }],
    execute: function () {
      ...
      function expect$1(parser, context, token, err = 1) {
      ...
      function parseTypeAlias(parser, context, pos) {
          ...
          expect$1(parser, context, 83886109);
          const typeAnnotation = parseType(parser, context);
      ...
      function parseIfStatement(parser, context) {
          const pos = getLocation$1(parser);
          expect$1(parser, context, 12377);
          expect$1(parser, context, 50331659);
          const test = parseExpression(parser, (context & ~1073741824) | 65536);
          expect$1(parser, context, 16);
          const consequent = parseConsequentOrAlternate(parser, context | 536870912);
          const alternate = consume$1(parser, context, 12370) ? parseConsequentOrAlternate(parser, context) : null;
          return finishNode$1(context, parser, pos, {
              type: 'IfStatement',
              test,
              consequent,
      ...
      function parseTryStatement(parser, context) {
          const pos = getLocation$1(parser);
          expect$1(parser, context, 12385);
          const block = parseBlockStatement(parser, context);
          const handler = parser.token === 12364 ? parseCatchBlock(parser, context) : null;
          const finalizer = consume$1(parser, context, 12373) ? parseBlockStatement(parser, context) : null;
      ...
      function parseCatchBlock(parser, context) {
          const pos = getLocation$1(parser);
          expect$1(parser, context, 12364);
          let param = null;
          if (context & 1
              ? consume$1(parser, context, 50331659)
              : expect$1(parser, context, 50331659)) {
              const params = [];
      ...
      function parseThrowStatement(parser, context) {
          const pos = getLocation$1(parser);
          expect$1(parser, context, 302002272);
          if (parser.flags & 1)
      ...
      function parseExpressionOrLabelledStatement(parser, context) {
          ...
          if (token & (65536 | 4096) && parser.token === 16777237) {
              ...
              expect$1(parser, context, 16777237, 81);
      ...
      function parseDoWhileStatement(parser, context) {
          const pos = getLocation$1(parser);
          expect$1(parser, context, 12369);
          const body = parseIterationStatement(parser, context);
          expect$1(parser, context, 12402);
          expect$1(parser, context, 50331659);
          const test = parseExpression(parser, (context & ~1073741824) | 65536);
          expect$1(parser, context, 16);
          consume$1(parser, context, 17301521);
      ...
      function parseBlockStatement(parser, context) {
          ...
          expect$1(parser, context, 17301519);
          return finishNode$1(context, parser, pos, {
              type: 'BlockStatement',
              body
          });
      ...
      function parseSwitchStatement(parser, context) {
          const pos = getLocation$1(parser);
          expect$1(parser, context, 33566814);
          expect$1(parser, context, 50331659);
          const discriminant = parseExpression(parser, (context & ~1073741824) | 65536);
          expect$1(parser, context, 16);
          expect$1(parser, context | 536870912, 41943052);
          const cases = [];
          const savedFlags = parser.flags;
          parser.flags |= 16;
      ...
      function parseCaseOrDefaultClauses(parser, context) {
          const pos = getLocation$1(parser);
          let test = null;
          if (consume$1(parser, context, 12363)) {
              test = parseExpression(parser, (context & ~1073741824) | 65536);
          }
          else {
              expect$1(parser, context, 12368);
          }
          expect$1(parser, context, 16777237);
          const consequent = [];
      ...
      function parseForStatement(parser, context) {
          const pos = getLocation$1(parser);
          expect$1(parser, context, 12374);
          const awaitToken = !!(context & 131072 && consume$1(parser, context, 33788013));
          expect$1(parser, context | 536870912, 50331659);
          const { token } = parser;
          let init = null;
          ...
          if (consume$1(parser, context, 1085554)) {
              type = 'ForOfStatement';
              if (init) {
          ...
          else if (consume$1(parser, context, 168834865)) {
              if (init) {
                  if (!(parser.flags & 4))
                      tolerant(parser, context, 71);
                  reinterpret(parser, context, init);
              ...
              if (variableStatement)
                  init = variableStatement;
              expect$1(parser, context, 17301521);
      ...
      function parseJSXRootElement(parser, context) {
          ...
          let openingElement;
          expect$1(parser, context, 167774015);
          ...
          if (isFragment) {
              ...
              selfClosing = consume$1(parser, context, 167774773);
      ...
      function parseJSXOpeningElement(parser, context, name, attributes, selfClosing, pos) {
          if (context & 268435456 && selfClosing)
              expect$1(parser, context, 167774016);
          else
              nextJSXToken(parser);
          return finishNode$1(context, parser, pos, {
      ...
      function scanJSXToken(parser) {
          ...
          if (char === 60) {
              parser.index++;
              parser.column++;
              return Scanner.consumeOpt(parser, 47) ? 25 : 167774015;
          }
          else if (char === 123) {
              parser.index++;
              parser.column++;
      ...
      function parseJSXElementName(parser, context) {
          ...
          while (consume$1(parser, context, 16777229)) {
      ...
      function parseSequenceExpression(parser, context, left, pos) {
          ...
          while (consume$1(parser, context, 16777234)) {
      ...
      function parseYieldExpression(parser, context, pos) {
          ...
          expect$1(parser, context, 1107316842);
          let argument = null;
          let delegate = false;
          if (!(parser.flags & 1)) {
              delegate = consume$1(parser, context, 167774771);
      ...
      function parseAssignmentExpression(parser, context) {
          ...
          if (hasBit(parser.token, 67108864)) {
              ...
              else if (consume$1(parser, context, 83886109)) {
                  if (!(parser.flags & 4)) {
                      tolerant(parser, context, 71);
                  }
                  if (!(context & 524288))
      ...
      function parseConditionalExpression(parser, context, pos) {
          ...
          if (!consume$1(parser, context, 22))
              return test;
      ...
      function parseBinaryExpression(parser, context, minPrec, pos, left = parseUnaryExpression(parser, context)) {
          ...
          while (hasBit(parser.token, 167772160)) {
              ...
              left = finishNode$1(context, parser, pos, {
                  ...
                  left,
                  right: parseBinaryExpression(parser, context & ~65536, prec, getLocation$1(parser)),
      ...
      function parseAwaitExpression(parser, context, pos) {
          ...
          expect$1(parser, context, 33788013);
          return finishNode$1(context, parser, pos, {
      ...
      function parseMemberExpression(parser, context, pos, expr = parsePrimaryExpression(parser, context)) {
          while (true) {
              switch (parser.token) {
                  case 16777229: {
                      consume$1(parser, context, 16777229);
                  ...
                  case 41943059: {
                      consume$1(parser, context, 41943059);
                      parser.flags = parser.flags & ~2 | 4;
                      const property = parseExpression(parser, context);
                      expect$1(parser, context, 20);
                      expr = finishNode$1(context, parser, pos, {
                          type: 'MemberExpression',
                          object: expr,
                          computed: true,
      ...
      function parseArgumentList(parser, context) {
          ...
          while (parser.token !== 16) {
              ...
              if (parser.token !== 16)
                  expect$1(parser, context, 16777234);
          }
          expect$1(parser, context, 16);
          return expressions;
      }
      function parseAsyncArgumentList(parser, context) {
          ...
          while (parser.token !== 16) {
              ...
              if (consume$1(parser, context, 16777234)) {
                  parser.flags &= ~4;
                  if (state & 2)
                      state = 1;
              }
      ...
      function parseIdentifier(parser, context) {
          const pos = getLocation$1(parser);
          const name = parser.tokenValue;
          nextToken$1(parser, context | 16384);
          const node = finishNode$1(context, parser, pos, {
              type: 'Identifier',
              name,
          });
      ...
      function parseThisExpression(parser, context) {
          if (parser.flags & 32768)
              tolerant(parser, context, 2);
          const pos = getLocation$1(parser);
          nextToken$1(parser, context | 536870912);
          return finishNode$1(context, parser, pos, {
              type: 'ThisExpression',
          });
      }
      ...
      function parseIdentifierNameOrPrivateName(parser, context) {
          if (!consume$1(parser, context, 115))
      ...
      function parseArrayLiteral(parser, context) {
          const pos = getLocation$1(parser);
          expect$1(parser, context, 41943059);
          const elements = [];
              ...
              default:
                  {
                      ...
                      if (parser.token === 16777234) {
                          ...
                          while (consume$1(parser, context | 536870912, 16777234)) {
                              parser.flags &= ~4;
                              switch (parser.token) {
                                  case 14:
                                      {
      ...
      function parseAsyncFunctionOrAsyncGeneratorExpression(parser, context) {
          const pos = getLocation$1(parser);
          expect$1(parser, context, 299116);
          expect$1(parser, context, 33566808);
          const isGenerator = consume$1(parser, context, 167774771) ? 1 : 0;
          const isAwait = 2;
          let id = null;
      ...
      function parsePropertyDefinition(parser, context) {
          ...
          let value;
          let state = consume$1(parser, context, 167774771) ? 2 | 32 : 32;
          const t = parser.token;
          ...
          if (!(parser.token & 16777216)) {
              if (flags & 32768) {
                  ...
                  state |= consume$1(parser, context, 167774771) ? 2 | 1 : 1;
      ...
      function parseFormalParameterList(parser, context, args) {
          ...
          if (!consume$1(parser, context, 83886109))
              return left;
      ...
      function parseClassExpression(parser, context) {
          ...
          expect$1(parser, context | 536870912, 33566797);
          const { token } = parser;
          let state = 0;
          let id = null;
          let superClass = null;
          ...
          return finishNode$1(context, parser, pos, context & 2048 ? {
      ...
      function parseClassBodyAndElementList(parser, context, state) {
          ...
          let decorators = [];
          while (parser.token !== 17301519) {
              if (!consume$1(parser, context, 17301521)) {
                  if (context & 2048) {
                      decorators = parseDecorators(parser, context);
                      if (parser.token === 17301519)
                          report(parser, 90);
      ...
      function parseClassElement(parser, context, state, decorators) {
          ...
          const flags = parser.flags;
          if (consume$1(parser, context, 167774771)) {
              state |= 2;
          }
          if (parser.token === 41943059)
              state |= 16;
      ...
      function parseFieldDefinition(parser, context, key, state, pos, decorators) {
          ...
          consume$1(parser, context, 16777234);
          return finishNode$1(context, parser, pos, context & 2048 ? {
      ...
      function parsePrivateFields(parser, context, decorators) {
          const pos = getLocation$1(parser);
          expect$1(parser, context | 32768, 115);
          if (parser.tokenValue === 'constructor')
      ...
      function parseCallImportOrMetaProperty(parser, context) {
          const pos = getLocation$1(parser);
          const id = parseIdentifier(parser, context);
          if (consume$1(parser, context, 16777229)) {
      ...
      function parseSuperProperty(parser, context) {
          const pos = getLocation$1(parser);
          expect$1(parser, context, 33566813);
          switch (parser.token) {
              case 50331659:
                  if (!(context & 67108864))
      ...
      function parseTemplate(parser, context, expressions = [], quasis = []) {
          const pos = getLocation$1(parser);
          const { tokenValue, tokenRaw } = parser;
          expect$1(parser, context, 33554440);
      ...
      function parseTemplateSpans(parser, context, pos = getLocation$1(parser)) {
          const { tokenValue, tokenRaw } = parser;
          expect$1(parser, context, 33554441);
          return finishNode$1(context, parser, pos, {
              type: 'TemplateElement',
              value: {
                  cooked: tokenValue,
      ...
      function parseDecorators(parser, context) {
          const decoratorList = [];
          while (consume$1(parser, context, 120)) {
      ...
      function parseBindingInitializer(parser, context) {
          ...
          return !consume$1(parser, context, 83886109) ?
              left :
      ...
      function parseAssignmentProperty(parser, context) {
          ...
          if (token & (65536 | 4096)) {
              ...
              shorthand = !consume$1(parser, context, 16777237);
              if (shorthand) {
                  const hasInitializer = consume$1(parser, context, 83886109);
                  if (context & 262144 && token & 1073741824)
                      tolerant(parser, context, 47);
      ...
      function parseVariableDeclaration(parser, context, isConst) {
          ...
          let init = null;
          if (consume$1(parser, context | 536870912, 83886109)) {
      ...
      function parseExportDeclaration(parser, context) {
          ...
          expect$1(parser, context | 536870912, 12371);
          switch (parser.token) {
              case 167774771:
              ...
              case 41943052:
                  {
                      ...
                      expect$1(parser, context | 536870912, 17301519);
      ...
      function parseExportAllDeclaration(parser, context, pos) {
          expect$1(parser, context, 167774771);
      ...
      function parseNamedExportDeclaration(parser, context) {
          ...
          const exported = consume$1(parser, context, 36971)
      ...
      function parseExportDefault(parser, context, pos) {
          expect$1(parser, context | 536870912, 12368);
          let declaration;
          switch (parser.token) {
              case 33566808:
      ...
      function parseImportDeclaration(parser, context) {
          const pos = getLocation$1(parser);
          expect$1(parser, context, 33566810);
          let source;
          let specifiers = [];
      ...
      function parseImportNamespaceSpecifier(parser, context, specifiers) {
          const pos = getLocation$1(parser);
          expect$1(parser, context, 167774771);
          expect$1(parser, context, 36971, 80);
