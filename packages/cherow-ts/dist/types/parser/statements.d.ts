 ...
 * @param context Context masks
 */
export declare function parseConstOrEnumDeclaration(parser: Parser, context: Context): ReturnType<typeof parseVariableStatement | typeof parseExpressionOrLabelledStatement>;
