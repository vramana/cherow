import { IParser, Location, Token, ESTree, Context, ObjectState } from 'cherow';
...
export declare function parseAssignmentExpression(parser: IParser, context: Context): ESTree.Expression;
