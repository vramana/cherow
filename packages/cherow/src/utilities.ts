 ...
 */
export function validateBreakOrContinueLabel(parser: IParser, context: Context, label: string, isContinue: boolean) {
 ...
 * @param label label
 */
export function addLabel(parser: IParser, label: string) {
 ...
 * @param label label
 */
export function popLabel(parser: IParser, label: string) {
...
export function validateParams(parser: IParser, context: Context, params: string[]) {
 ...
 * @param parser Parser object
 */
export function setPendingError(parser: IParser) {
 ...
 * @param prefix
 */
export function validateUpdateExpression(parser: IParser, context: Context, expr: ESTree.Expression, prefix: string) {
 ...
 */
export function setPendingExpressionError(parser: IParser, type: Errors) {
