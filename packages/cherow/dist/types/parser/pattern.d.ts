...
export declare function parseBindingIdentifierOrPattern(parser: IParser, context: Context, args?: string[]): ESTree.Node;
...
export declare function parseAssignmentPattern(parser: IParser, context: Context, left: ESTree.Node, pos: Location): ESTree.AssignmentPattern;
