...
export declare function parseStatementListItem(parser: IParser, context: Context): any;
export declare function parseStatement(parser: IParser, context: Context): any;
...
export declare function parseTryStatement(parser: IParser, context: Context): ESTree.Node;
export declare function parseCatchBlock(parser: IParser, context: Context): ESTree.CatchClause;
export declare function parseThrowStatement(parser: IParser, context: Context): ESTree.Node;
