...
export declare function parseStatementListItem(parser: Parser, context: Context): any;
export declare function parseStatement(parser: Parser, context: Context): any;
...
export declare function parseTryStatement(parser: Parser, context: Context): ESTree.Node;
export declare function parseCatchBlock(parser: Parser, context: Context): ESTree.CatchClause;
export declare function parseThrowStatement(parser: Parser, context: Context): ESTree.Node;
