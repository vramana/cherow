    ...
    loop: while (this.hasNext()) {
        switch (this$1.nextChar()) {
            case 95 /* Underscore */:
                ...
                this$1.flags |= -2147483648 /* ContainsSeparator */;
...
Parser.prototype.scanNumericFragment = function scanNumericFragment (state) {
    this.flags |= -2147483648 /* ContainsSeparator */;
    if (!(state & 256 /* AllowSeparator */)) {
        this.error(111 /* InvalidNumericSeparators */);
    }
    state &= ~256 /* AllowSeparator */;
...
Parser.prototype.scanNumber = function scanNumber (context, ch) {
    ...
    if (ch === 48 /* Zero */) {
        ...
        if (this.flags & -2147483648 /* ContainsSeparator */) {
...
Parser.prototype.scanString = function scanString (context, quote) {
    ...
    if (!(this.flags & 2 /* ExtendedUnicodeEscape */) && ret === 'use strict') {
        this.flags |= 8192 /* DirectivePrologue */;
    }
    this.advance(); // Consume the quote
...
Parser.prototype.handleStringError = function handleStringError (code) {
    switch (code) {
        ...
        case -6 /* TemplateOctalLiteral */:
            this.error(98 /* TemplateOctalLiteral */);
        case -3 /* EightOrNine */:
...
Parser.prototype.parseStatementList = function parseStatementList (context, endToken) {
    ...
    while (this.token === 262147 /* StringLiteral */) {
        ...
        if (!isPrologueDirective(item))
            { break; }
        if (this$1.flags & 8192 /* DirectivePrologue */) {
...
Parser.prototype.isIdentifierOrKeyword = function isIdentifierOrKeyword (t) {
    return t === 134479873 /* Identifier */ || hasMask(t, 4096 /* Keyword */);
};
...
Parser.prototype.parseExportDeclaration = function parseExportDeclaration (context) {
    ...
    this.expect(context | 268435456 /* ValidateEscape */, 12371 /* ExportKeyword */);
    switch (this.token) {
        ...
        case 393228 /* LeftBrace */:
            ...
            this.expect(context | 268435456 /* ValidateEscape */, 15 /* RightBrace */);
        ...
        case 8663113 /* ConstKeyword */:
            declaration = this.parseVariableStatement(context | 1073741824 /* Const */);
            break;
        // export LexicalDeclaration
        case 8671304 /* LetKeyword */:
            declaration = this.parseVariableStatement(context | 536870912 /* Let */);
            break;
...
Parser.prototype.parseExportSpecifier = function parseExportSpecifier (context) {
    var pos = this.getLocations();
    if (this.token === 134479873 /* Identifier */)
        { this.addBlockName(this.tokenValue); }
    var local = this.parseIdentifierName(context | 268435456 /* ValidateEscape */, this.token);
    var exported = local;
...
Parser.prototype.parseImportSpecifier = function parseImportSpecifier (context) {
    ...
    if (this.isIdentifier(context, this.token)) {
        imported = this.parseIdentifier(context | 268435456 /* ValidateEscape */);
        local = imported;
        if (this.token === 69739 /* AsKeyword */) {
            this.expect(context, 69739 /* AsKeyword */);
            this.checkIfExistInBlockScope(this.tokenValue, true);
...
Parser.prototype.parseImportNamespaceSpecifier = function parseImportNamespaceSpecifier (context) {
    var pos = this.getLocations();
    this.expect(context | 268435456 /* ValidateEscape */, 2099763 /* Multiply */);
    if (this.token !== 69739 /* AsKeyword */) {
        this.error(37 /* NoAsAfterImportNamespace */);
    }
    this.expect(context, 69739 /* AsKeyword */);
    this.checkIfExistInBlockScope(this.tokenValue, true);
    if (this.token !== 134479873 /* Identifier */)
...
Parser.prototype.parseImportDeclaration = function parseImportDeclaration (context) {
    ...
    switch (this.token) {
        ...
        // import {bar}
        case 393228 /* LeftBrace */:
            this.parseNamedImports(context | 268435456 /* ValidateEscape */, specifiers);
            break;
        // import * as foo
        case 2099763 /* Multiply */:
            specifiers.push(this.parseImportNamespaceSpecifier(context));
...
Parser.prototype.parseContinueStatement = function parseContinueStatement (context) {
    ...
    if (label === null && !(this.flags & 32 /* IterationStatement */))
...
Parser.prototype.parseForStatement = function parseForStatement (context) {
    ...
    var blockScope = this.blockScope;
    var parentScope = this.parentScope;
    var awaitToken = (context & 32 /* Await */) !== 0 && this.parseOptional(context, 331885 /* AwaitKeyword */);
    var savedFlag = this.flags;
    if (blockScope !== undefined)
        { this.parentScope = blockScope; }
    this.blockScope = undefined;
...
Parser.prototype.parseVariableDeclaration = function parseVariableDeclaration (context) {
    var pos = this.getLocations();
    var token = this.token;
    var id = this.parseIdentifierOrPattern(context | 134217728 /* ForceBinding */);
    var init = null;
    if (hasMask(token, 131072 /* BindingPattern */)) {
        if (this.parseOptional(context, 1310749 /* Assign */)) {
            init = this.parseAssignmentExpression(context & ~(1610612736 /* Lexical */ | 524288 /* ForStatement */));
            if (!(context & 1610612736 /* Lexical */) && context & 524288 /* ForStatement */) {
        ...
        if (this.parseOptional(context, 1310749 /* Assign */)) {
            ...
            if (context & 524288 /* ForStatement */ && this.isInOrOfKeyword(this.token)) {
                if (context & (2 /* Strict */ | 1610612736 /* Lexical */)) {
                    this.error(this.token === 2111281 /* InKeyword */ ?
                        87 /* InvalidVarDeclInForIn */ :
                        88 /* InvalidVarDeclInForOf */);
                }
            }
        }
        else if (context & 1073741824 /* Const */ && !this.isInOrOfKeyword(this.token)) {
    ...
    switch (params.type) {
        ...
        case 'Identifier':
            ...
            if (context & 2 /* Strict */ && this.isEvalOrArguments(params.name)) {
                this.error(85 /* InvalidBindingStrictMode */, params.name);
            }
            return;
        case 'ObjectExpression':
        ...
        case 'RestElement':
            ...
            if (params.argument.type === 'AssignmentPattern')
...
Parser.prototype.parseUpdateExpression = function parseUpdateExpression (context, pos) {
    ...
    if (hasMask(this.token, 786432 /* UpdateOperator */)) {
        ...
        if (context & 2 /* Strict */ && this.isEvalOrArguments(expr.name)) {
            ...
            { this.error(115 /* InvalidLhsInPrefixOp */); }
        return this.finishNode(context, pos, {
    ...
    if (hasMask(this.token, 786432 /* UpdateOperator */) && !(this.flags & 1 /* PrecedingLineBreak */)) {
        ...
        if (context & 2 /* Strict */ && this.isEvalOrArguments(expr.name)) {
            ...
            this.error(114 /* InvalidLhsInPostfixOp */);
        }
    ...
    if (this.token !== 262155 /* LeftParen */) {
        ...
        if (context & 33554432 /* Expression */) {
            ...
            if (parent & 32 /* Await */ && this.token === 331885 /* AwaitKeyword */) {
                this.error(106 /* InvalidAwaitInAsyncFunc */);
            }
...
Parser.prototype.parseParameterList = function parseParameterList (context, state) {
    ...
    while (this.token !== 16 /* RightParen */) {
        ...
        result.push(this$1.parseFormalParameters(context & ~134217728 /* ForceBinding */));
...
Parser.prototype.parseFormalParameters = function parseFormalParameters (context) {
    ...
    var left = this.parseIdentifierOrPattern(context);
...
Parser.prototype.parseFunctionBody = function parseFunctionBody (context) {
    ...
    if (this.token !== 15 /* RightBrace */) {
        ...
        body = this.parseStatementList(context & ~1610612736 /* Lexical */, 15 /* RightBrace */);
...
Parser.prototype.parseClass = function parseClass (context) {
    ...
    var flags = 0;
    var id = null;
    var next = (this.flags & 8388608 /* OptionsNext */) !== 0;
    var savedFlags = this.flags;
    if (this.isIdentifier(context, this.token)) {
        var name = this.tokenValue;
        if (!(context & 33554432 /* Expression */)) {
...
Parser.prototype.parseClassBody = function parseClassBody (context, flags) {
    ...
    var pos = this.getLocations();
    this.expect(context | 268435456 /* ValidateEscape */, 393228 /* LeftBrace */);
    var body = [];
    if (this.token !== 15 /* RightBrace */) {
        while (this.token !== 15 /* RightBrace */) {
...
Parser.prototype.parseClassElement = function parseClassElement (context, state) {
    ...
    switch (this.token) {
        ...
        case 393235 /* LeftBracket */:
            state |= 4 /* Computed */;
            fieldPos = this.getLocations();
            key = this.parseComputedPropertyName(context | 4 /* AllowIn */, pos);
            if (this.flags & 8388608 /* OptionsNext */ && this.token !== 262155 /* LeftParen */) {
                return this.parseClassFields(context | 4 /* AllowIn */ | 8388608 /* Fields */, key, fieldPos);
            }
            break;
...
Parser.prototype.parseObjectElement = function parseObjectElement (context) {
    ...
    switch (this.token) {
        ...
        case 16846960 /* SetKeyword */:
            if (isEscaped)
                { this.error(64 /* UnexpectedEscapedKeyword */); }
            state |= currentState = this.token === 16846959 /* GetKeyword */ ?
                16 /* Get */ :
                32 /* Set */;
            key = this.parseIdentifier(context);
            count++;
...
Parser.prototype.parseRestElement = function parseRestElement (context) {
    var pos = this.getLocations();
    this.expect(context, 14 /* Ellipsis */);
    var argument = this.parseIdentifierOrPattern(context);
    if (this.token === 1310749 /* Assign */)
        { this.error(1 /* UnexpectedToken */, tokenDesc(this.token)); }
    if (!(context & 134217728 /* ForceBinding */) && this.token !== 16 /* RightParen */) {
...
Parser.prototype.parseLiteral = function parseLiteral (context) {
    ...
    var value = this.tokenValue;
    var raw = this.tokenRaw;
    if (context & 2 /* Strict */ && this.flags & 131072 /* Octal */) {
...
Parser.prototype.parseAssignmentPattern = function parseAssignmentPattern (context, pos, pattern) {
        ...
        if ( pattern === void 0 ) pattern = this.parseIdentifierOrPattern(context);
...
Parser.prototype.parseIdentifierOrPattern = function parseIdentifierOrPattern (context) {
    switch (this.token) {
        case 393235 /* LeftBracket */:
...
Parser.prototype.parseBindingIdentifier = function parseBindingIdentifier (context) {
    var t = this.token;
    if (context & 134217728 /* ForceBinding */ && !this.isIdentifier(context, this.token)) {
        this.error(0 /* Unexpected */);
    }
    else if (!this.isIdentifier(context, this.token)) {
        this.throwUnexpectedToken();
    }
    else if (context & 1610612736 /* Lexical */ && this.token === 8671304 /* LetKeyword */) {
...
Parser.prototype.parseRestProperty = function parseRestProperty (context) {
    ...
    if (this.token !== 134479873 /* Identifier */)
        { this.throwUnexpectedToken(); }
    var arg = this.parseIdentifierOrPattern(context);
    if (this.token === 1310749 /* Assign */)
        { this.throwUnexpectedToken(); }
    return this.finishNode(context, pos, {
        type: 'RestElement',
