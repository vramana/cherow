...
ErrorMessages[31 /* DeclarationMissingInitializer */] = 'Missing initializer in destructuring declaration';
ErrorMessages[34 /* InvalidLHSInForLoop */] = 'Invalid left-hand side in for-loop';
ErrorMessages[32 /* InvalidVarInitForOf */] = ' for-of loop variable declaration may not have an initializer';
ErrorMessages[33 /* InvalidVarInitForIn */] = ' for-in loop variable declaration may not have an initializer';
ErrorMessages[36 /* InvalidLHSInForOf */] = 'Invalid left-hand side in for-of';
ErrorMessages[35 /* InvalidLHSInForIn */] = 'Invalid left-hand side in for-in';
...
ErrorMessages[71 /* MissingArrowAfterParentheses */] = 'Missing => after parentheses';
ErrorMessages[39 /* MissingAsImportSpecifier */] = 'Missing \'as\' keyword in import namespace specifier';
ErrorMessages[40 /* NoAsAfterImportNamespace */] = 'Missing \'as\' keyword after import namespace';
ErrorMessages[41 /* InvalidModuleSpecifier */] = 'Invalid module specifier';
ErrorMessages[42 /* NonEmptyJSXExpression */] = 'JSX attributes must only be assigned a non-empty  \'expression\'';
ErrorMessages[43 /* ExpectedJSXClosingTag */] = 'Expected corresponding JSX closing tag for %0';
ErrorMessages[44 /* AdjacentJSXElements */] = 'Adjacent JSX elements must be wrapped in an enclosing tag';
ErrorMessages[45 /* InvalidBinaryDigit */] = 'Invalid binary digit';
ErrorMessages[46 /* InvalidOctalDigit */] = 'Invalid octal digit';
ErrorMessages[47 /* StrictDelete */] = 'Identifier expressions must not be deleted in strict mode';
ErrorMessages[48 /* StrictLHSPrefix */] = 'Prefix increment/decrement may not have eval or arguments operand in strict mode';
ErrorMessages[49 /* StrictLHSPostfix */] = 'Postfix increment/decrement may not have eval or arguments operand in strict mode';
ErrorMessages[51 /* ExportDeclAtTopLevel */] = 'Export declarations may only appear at top level of a module';
ErrorMessages[52 /* ImportDeclAtTopLevel */] = 'Import declarations may only appear at top level of a module';
ErrorMessages[53 /* MissingMsgDeclarationAfterExport */] = 'Missing declaration after \'export\' keyword';
ErrorMessages[54 /* MissingMsgDeclarationAfterImport */] = 'Missing declaration after \'import\' keyword';
ErrorMessages[55 /* ForAwaitNotOf */] = 'For await loop should be used with \'of\'';
ErrorMessages[56 /* LetInLexicalBinding */] = 'let is disallowed as a lexically bound name';
ErrorMessages[57 /* UnexpectedComma */] = 'Unexpected token ,';
ErrorMessages[58 /* DuplicateProtoProperty */] = 'Property name __proto__ appears more than once in object literal';
ErrorMessages[59 /* StrictParamDupe */] = 'Duplicate argument names not allowed in this context';
ErrorMessages[60 /* InvalidHexEscapeSequence */] = 'Invalid hexadecimal escape sequence';
ErrorMessages[61 /* ConstructorSpecialMethod */] = 'Class constructor may not be an accessor';
ErrorMessages[62 /* BadSuperCall */] = 'super() is only valid in derived class constructors';
ErrorMessages[63 /* DuplicateConstructor */] = 'A class may only have one constructor';
ErrorMessages[65 /* ConstructorIsAsync */] = 'Class constructor may not be an async method';
ErrorMessages[64 /* StaticPrototype */] = 'Classes may not have static property named prototype';
ErrorMessages[67 /* ClassDeclarationNoName */] = 'Class declaration must have a name in this context';
ErrorMessages[68 /* FunctionDeclarationNoName */] = 'Function declaration must have a name in this context';
ErrorMessages[69 /* LineBreakAfterAsync */] = 'No line break is allowed after async';
...
ErrorMessages[78 /* UnexpectedReservedWord */] = 'Unexpected reserved word';
ErrorMessages[79 /* InvalidShorthandProperty */] = 'Invalid shorthand property';
ErrorMessages[80 /* InvalidShorthandAssignment */] = 'Shorthand property assignments are valid only in destructuring patterns';
ErrorMessages[81 /* UnterminatedTemplate */] = 'Unterminated template literal';
ErrorMessages[82 /* UnexpectedStrictReserved */] = 'Unexpected strict mode reserved word';
ErrorMessages[83 /* YieldReservedWord */] = 'yield is a reserved word inside generator functions';
ErrorMessages[84 /* StrictParamName */] = 'The identifier \'eval\' or \'arguments\' must not be in binding position in strict mode';
ErrorMessages[85 /* DisallowedInContext */] = '\'%0\' may not be used as an identifier in this context';
ErrorMessages[86 /* IllegalArrowInParamList */] = 'Illegal arrow function parameter list';
ErrorMessages[87 /* UnexpectedBigIntLiteral */] = 'Unexpected BigInt literal';
ErrorMessages[88 /* UnNamedClassStmt */] = 'Class statement requires a name';
ErrorMessages[89 /* UnNamedFunctionStmt */] = 'Function statement requires a name';
ErrorMessages[90 /* InvalidStrictExpPostion */] = 'The identifier \'%0\' must not be in expression position in strict mode';
ErrorMessages[91 /* InvalidBindingStrictMode */] = 'The identifier \'%0\' must not be in binding position in strict mode';
...
ErrorMessages[99 /* UnexpectedMantissa */] = 'Unexpected mantissa';
ErrorMessages[100 /* UnexpectedSurrogate */] = 'Unexpected surrogate pair';
ErrorMessages[101 /* ForbiddenAsStatement */] = '%0 can\'t appear in single-statement context';
ErrorMessages[102 /* InvalidAsyncGenerator */] = 'Generator function or method can\'t be async';
ErrorMessages[103 /* BadPropertyId */] = 'Invalid property id';
ErrorMessages[104 /* InvalidMethod */] = 'Only methods are allowed in classes';
ErrorMessages[105 /* InvalidArrowYieldParam */] = 'Arrow parameters must not contain yield expressions';
ErrorMessages[106 /* InvalidAwaitInArrowParam */] = '\'await\' is not allowed inside an async arrow\'s parameter list';
ErrorMessages[107 /* InvalidComplexBindingPattern */] = 'Complex binding patterns require an initialization value';
ErrorMessages[108 /* UnsupportedFeature */] = '%0 isn\'t supported by default. Enable the \'%1\' option to use them';
ErrorMessages[109 /* BadUntaggedTemplate */] = 'Bad escape sequence in untagged template literal';
ErrorMessages[110 /* TemplateOctalLiteral */] = 'Template literals may not contain octal escape sequences';
ErrorMessages[111 /* InvalidForBindingInit */] = 'Binding pattern appears without initializer in for statement init';
ErrorMessages[112 /* InvalidNestedContinue */] = 'Continue statement must be nested within an iteration statement';
ErrorMessages[113 /* InvalidWithBody */] = 'The body of a with statement must not be a labeled function declaration';
ErrorMessages[114 /* InvalidGeneratorParam */] = 'Generator parameters must not contain yield expressions';
ErrorMessages[116 /* IllegalArrowFuncParamList */] = 'Illegal arrow function parameter list';
...
var Parser = function Parser(source, options) {
    ...
    if (options.comments)
        { this.flags |= 33554432 /* OptionsComments */; }
    if (options.jsx)
    ...
    if (this.flags & 33554432 /* OptionsComments */)
        { this.comments = options.comments; }
    if (this.flags & (524288 /* OptionsLoc */ | 1048576 /* OptionsSource */))
...
Parser.prototype.scanToken = function scanToken (context) {
    ...
    if (!(context & 2 /* Strict */) && this.flags & 8192 /* HasStrictDirective */) {
        context |= 2 /* Strict */;
    }
            ...
            case 48 /* Zero */:
                {
                    ...
                    if (index$1 < this$1.source.length && nextChar >= 48 /* Zero */ && nextChar <= 57 /* Nine */) {
...
Parser.prototype.skipComments = function skipComments (state) {
    ...
    if (state & 24 /* Collectable */ && this.flags & 33554432 /* OptionsComments */) {
        var loc = {};
...
Parser.prototype.peekExtendedUnicodeEscape = function peekExtendedUnicodeEscape () {
    ...
    // '\u{DDDDDDDD}'
    if (ch === 123 /* LeftBrace */) {
        ch = this.scanNext(ch, 60 /* InvalidHexEscapeSequence */);
        // At least, one hex digit is required.
        if (ch === 125 /* RightBrace */) {
            this.error(60 /* InvalidHexEscapeSequence */);
        }
        while (ch !== 125 /* RightBrace */) {
            var digit = toHex(ch);
            if (digit < 0)
                { this$1.error(60 /* InvalidHexEscapeSequence */); }
            code = (code << 4) | digit;
            if (code > 1114111 /* LastUnicodeChar */)
                { this$1.error(5 /* UnicodeOutOfRange */); }
            // At least one digit is expected
            ch = this$1.scanNext(ch, 60 /* InvalidHexEscapeSequence */);
        }
        return code;
    }
...
Parser.prototype.scanNumberLiteral = function scanNumberLiteral (context) {
    ...
    if (isDecimal && ch === 46 /* Period */)
        { this.advanceAndSkipDigits(); }
    if (this.flags & 8388608 /* OptionsNext */ && this.consume(110 /* LowerN */))
        { this.flags |= 16384 /* BigInt */; }
...
Parser.prototype.scanOctalDigits = function scanOctalDigits (context) {
    ...
    if (ch < 48 /* Zero */ || ch >= 56 /* Eight */)
        { this.error(45 /* InvalidBinaryDigit */); }
    this.advance();
    while (this.hasNext()) {
        ch = this$1.nextChar();
        ...
        case 101 /* LowerE */:
            ...
            switch (this.nextChar()) {
                ...
                case 45 /* Hyphen */:
                    this.advance();
                    if (!this.hasNext())
                        { this.error(98 /* UnexpectedTokenNumber */); }
                default: // ignore
            }
            cp = this.nextChar();
            // we must have at least one decimal digit after 'e'/'E'
            if (!(cp >= 48 /* Zero */ && cp <= 57 /* Nine */))
                { this.error(99 /* UnexpectedMantissa */); }
            this.advanceAndSkipDigits();
            end = this.index;
            break;
...
Parser.prototype.handleStringError = function handleStringError (code) {
    switch (code) {
        ...
        case -6 /* TemplateOctalLiteral */:
            this.error(110 /* TemplateOctalLiteral */);
        case -3 /* EightOrNine */:
...
Parser.prototype.scanEscape = function scanEscape (context, cp, isTemplate) {
    ...
    switch (cp) {
        ...
        case 120 /* LowerX */:
            {
                var ch1 = this.scanNext(cp);
                var hi = toHex(ch1);
                if (hi < 0)
                    { return -4 /* InvalidHex */; }
                var ch2 = this.scanNext(ch1);
                var lo = toHex(ch2);
                if (lo < 0)
                    { return -4 /* InvalidHex */; }
                return hi << 4 | lo;
...
Parser.prototype.scanTemplate = function scanTemplate (context, first) {
    ...
    var tail = true;
    var ret = '';
    var ch = this.scanNext(first, 81 /* UnterminatedTemplate */);
    loop: while (ch !== 96 /* Backtick */) {
        switch (ch) {
            ...
            // '/'
            case 92 /* Backslash */:
                ch = this$1.scanNext(ch, 81 /* UnterminatedTemplate */);
                if (ch >= 128) {
                    ret += fromCodePoint(ch);
                }
                else {
...
Parser.prototype.parseModuleItemList = function parseModuleItemList (context) {
    ...
    if (this.flags & 16777216 /* OptionsDirectives */) {
...
Parser.prototype.parseStatementList = function parseStatementList (context, endToken) {
    ...
    var statements = [];
    var enableDirectiveNode = !!(this.flags & 16777216 /* OptionsDirectives */);
    while (this.token === 262147 /* StringLiteral */) {
        ...
        if (!isPrologueDirective(item))
            { break; }
        if (this$1.flags & 8192 /* HasStrictDirective */) {
            if (this$1.flags & 32768 /* SimpleParameterList */)
                { this$1.error(26 /* IllegalUseStrict */); }
            if (this$1.flags & 4096 /* BindingPosition */)
                { this$1.error(82 /* UnexpectedStrictReserved */); }
            context |= 2 /* Strict */;
        }
    }
...
Parser.prototype.finishNode = function finishNode (loc, node) {
    ...
    if (this.flags & 524288 /* OptionsLoc */) {
        ...
        if (this.flags & 1048576 /* OptionsSource */) {
            node.loc.source = this.locSource;
        }
    }
    return node;
};
Parser.prototype.parseEventually = function parseEventually (context, t) {
    if (this.token !== t)
        { return false; }
    this.nextToken(context);
    return true;
...
Parser.prototype.isIdentifier = function isIdentifier (context, t) {
    if (context & 2 /* Strict */) {
        if (t === 8671304 /* LetKeyword */)
            { this.error(91 /* InvalidBindingStrictMode */, tokenDesc(this.token)); }
        if (context & 1 /* Module */) {
...
Parser.prototype.parseExportDeclaration = function parseExportDeclaration (context) {
    ...
    switch (this.token) {
        ...
        // Falls through
        default:
            this.error(53 /* MissingMsgDeclarationAfterExport */);
    }
    return this.finishNode(pos, {
...
Parser.prototype.parseModuleSpecifier = function parseModuleSpecifier (context) {
    ...
    if (this.token !== 262147 /* StringLiteral */)
        { this.error(41 /* InvalidModuleSpecifier */); }
...
Parser.prototype.parseStatementListItem = function parseStatementListItem (context) {
    switch (this.token) {
        ...
        case 12371 /* ExportKeyword */:
            if (context & 1 /* Module */)
                { this.error(51 /* ExportDeclAtTopLevel */); }
        case 274521 /* ImportKeyword */:
            ...
            if (context & 1 /* Module */)
                { this.error(52 /* ImportDeclAtTopLevel */); }
        default:
...
Parser.prototype.parseStatement = function parseStatement (context) {
    switch (this.token) {
        ...
        case 274509 /* ClassKeyword */:
            this.error(101 /* ForbiddenAsStatement */, tokenDesc(this.token));
        default:
            return this.parseExpressionStatement(context);
    }
};
...
Parser.prototype.parseTryStatement = function parseTryStatement (context) {
    ...
    if (this.parseEventually(context, 12373 /* FinallyKeyword */)) {
...
Parser.prototype.parseWithStatement = function parseWithStatement (context) {
    ...
    return this.finishNode(pos, {
        type: 'WithStatement',
        object: object,
        body: this.parseStatement(context & ~1024 /* TopLevel */ | 4194304 /* Iteration */)
    });
};
Parser.prototype.parseWhileStatement = function parseWhileStatement (context) {
    ...
    this.flags |= 32 /* Iteration */ | 128 /* Continue */;
...
Parser.prototype.parseDoWhileStatement = function parseDoWhileStatement (context) {
    ...
    this.expect(context, 16 /* RightParen */);
    this.parseEventually(context, 17 /* Semicolon */);
    return this.finishNode(pos, {
    ...
    if (this.parseEventually(context, 69746 /* OfKeyword */)) {
        ...
        if (declarations) {
            ...
            if (!isValidDestructuringAssignmentTarget(init))
                { this.error(34 /* InvalidLHSInForLoop */); }
        }
...
Parser.prototype.parseForBody = function parseForBody (context, pos) {
    this.expect(context, 16 /* RightParen */);
    return this.parseStatement(context & ~1024 /* TopLevel */);
};
...
Parser.prototype.parseIfStatement = function parseIfStatement (context) {
    ...
    var alternate = null;
    if (this.parseEventually(context, 12370 /* ElseKeyword */))
...
Parser.prototype.parseFunctionDeclaration = function parseFunctionDeclaration (context) {
    ...
    if (this.token !== 262155 /* LeftParen */) {
        ...
        { this.error(89 /* UnNamedFunctionStmt */); }
    var savedScope = this.enterFunctionScope();
...
Parser.prototype.parseLabelledStatement = function parseLabelledStatement (context) {
    ...
    if (this.token === 21 /* Colon */ && expr.type === 'Identifier') {
        ...
        if (this.labelSet === undefined)
            ...
            { this.error(75 /* Redeclaration */, expr.name); }
        this.labelSet[key] = true;
        var body;
        switch (this.token) {
            case 274519 /* FunctionKeyword */:
                if (context & 4194304 /* Iteration */)
                    { this.error(113 /* InvalidWithBody */); }
                if (context & 524288 /* ForStatement */ || this.flags & 32 /* Iteration */)
...
Parser.prototype.parseVariableDeclarationList = function parseVariableDeclarationList (context) {
    ...
    if (this.token !== 18 /* Comma */)
        { return list; }
    while (this.parseEventually(context, 18 /* Comma */))
        { list.push(this$1.parseVariableDeclaration(context)); }
    return list;
};
Parser.prototype.isInOrOfKeyword = function isInOrOfKeyword (t) {
    switch (t) {
...
Parser.prototype.parseVariableDeclaration = function parseVariableDeclaration (context) {
    var pos = this.getLocations();
    var token = this.token;
    var id = this.parseBindingPatternOrIdentifier(context);
    var init = null;
    if (hasMask(token, 131072 /* BindingPattern */)) {
        if (this.parseEventually(context, 1310749 /* Assign */)) {
            init = this.parseAssignmentExpression(context & ~(402653184 /* Lexical */ | 524288 /* ForStatement */));
            if (!(context & 402653184 /* Lexical */) && context & 524288 /* ForStatement */) {
                if (this.token === 2111281 /* InKeyword */) {
                    this.error(94 /* InvalidVarDeclInForIn */);
                }
            }
        }
        else if (context & 402653184 /* Lexical */) {
            if (!this.isInOrOfKeyword(this.token)) {
                this.error(31 /* DeclarationMissingInitializer */);
            }
        }
        else if (!(context & 524288 /* ForStatement */)) {
            this.error(31 /* DeclarationMissingInitializer */);
        }
    }
    else {
        if (this.parseEventually(context, 1310749 /* Assign */)) {
            init = this.parseAssignmentExpression(context & ~(402653184 /* Lexical */ | 524288 /* ForStatement */));
            if (context & 524288 /* ForStatement */ && this.isInOrOfKeyword(this.token)) {
                if (context & (2 /* Strict */ | 402653184 /* Lexical */)) {
                    this.error(this.token === 2111281 /* InKeyword */ ?
                        94 /* InvalidVarDeclInForIn */ :
                        95 /* InvalidVarDeclInForOf */);
                }
            }
        }
        else if (context & 268435456 /* Const */ && !this.isInOrOfKeyword(this.token)) {
            this.error(92 /* MissingInitializer */, 'const');
        }
    }
    return this.finishNode(pos, {
...
Parser.prototype.parseYieldExpression = function parseYieldExpression (context, pos) {
    ...
    var delegate = false;
    if (!(this.flags & 1 /* LineTerminator */)) {
        delegate = this.parseEventually(context, 2099763 /* Multiply */);
        if (delegate) {
...
Parser.prototype.parseAssignmentExpression = function parseAssignmentExpression (context) {
    ...
    if (context & 16 /* Yield */ && this.token === 282730 /* YieldKeyword */) {
        ...
        if (context & 128 /* InParameter */ && !(this.flags & 4 /* InFunctionBody */)) {
            this.error(114 /* InvalidGeneratorParam */);
        }
    ...
    if (this.token === 10 /* Arrow */ && (this.isIdentifier(context | 8 /* Arrow */, token))) {
        if (!(this.flags & 1 /* LineTerminator */)) {
            if (this.isEvalOrArguments(expr.name)) {
                ...
                this.flags |= 4096 /* BindingPosition */;
            }
    ...
    if (hasMask(this.token, 1310720 /* AssignOperator */)) {
        ...
        if (context & 2 /* Strict */ && this.isEvalOrArguments(expr.name)) {
            ...
            if (this.flags & 2048 /* HaveSeenRest */)
        ...
        else if (context & 64 /* InParenthesis */) {
            this.flags |= 131072 /* Operator */;
        }
        this.nextToken(context);
        if (context & 16 /* Yield */ && context & 64 /* InParenthesis */ && this.token === 282730 /* YieldKeyword */) {
            this.flags |= 512 /* HaveSeenYield */;
        }
...
Parser.prototype.reinterpretAsPattern = function reinterpretAsPattern (context, params) {
    ...
    switch (params.type) {
        ...
        case 'Identifier':
            ...
            if (context & 2 /* Strict */ && this.isEvalOrArguments(params.name)) {
                this.error(91 /* InvalidBindingStrictMode */, params.name);
            }
            return;
        case 'ObjectExpression':
            if (this.flags & 65536 /* ParenthesizedPattern */)
                { this.error(72 /* InvalidParenthesizedPattern */); }
        ...
        case 'SpreadElement':
            ...
            if (context & 524288 /* ForStatement */ && params.argument.type === 'AssignmentExpression') {
                this.error(35 /* InvalidLHSInForIn */);
            }
        // Fall through
        case 'RestElement':
...
Parser.prototype.parseConditionalExpression = function parseConditionalExpression (context, pos) {
    ...
    if (!this.parseEventually(context, 22 /* QuestionMark */))
        { return expr; }
...
Parser.prototype.parseUpdateExpression = function parseUpdateExpression (context, pos) {
    ...
    if (hasMask(this.token, 786432 /* UpdateOperator */) && !(this.flags & 1 /* LineTerminator */)) {
        ...
        if (context & 2 /* Strict */ && this.isEvalOrArguments(expr.name)) {
            this.error(49 /* StrictLHSPostfix */);
        }
            ...
            case 13 /* Period */:
                {
                    ...
                    var property = this$1.flags & 8388608 /* OptionsNext */ && context & 65536 /* Method */ && this$1.token === 117 /* Hash */ ?
                    ...
                    if (context & 524288 /* ForStatement */ && this$1.token === 69746 /* OfKeyword */) {
                        ...
                        this$1.error(36 /* InvalidLHSInForOf */);
                    }
                    expr = this$1.finishNode(pos, {
...
Parser.prototype.parseParameterList = function parseParameterList (context, state) {
    ...
    while (this.token !== 16 /* RightParen */) {
        if (this$1.token === 14 /* Ellipsis */) {
            ...
            this$1.flags |= 32768 /* SimpleParameterList */;
            if (state & 32 /* Set */)
        ...
        if (!(context & 2 /* Strict */) && this$1.token !== 262145 /* Identifier */) {
...
Parser.prototype.parseAsyncFunctionExpression = function parseAsyncFunctionExpression (context, pos) {
    ...
    switch (this.token) {
        ...
        case 274519 /* FunctionKeyword */:
            ...
            if (this.flags & 1 /* LineTerminator */)
                { return id; }
            return this.parseFunctionExpression(context & ~(16 /* Yield */ | 65536 /* Method */) | 32 /* Await */, pos);
...
Parser.prototype.parseAsyncArguments = function parseAsyncArguments (context, pos, id, flags, isEscaped) {
    ...
    if (this.token === 10 /* Arrow */) {
        ...
        if (this.flags & 1024 /* HaveSeenAwait */)
            { this.error(106 /* InvalidAwaitInArrowParam */); }
        if (state & 1 /* EvalOrArg */)
            { this.error(84 /* StrictParamName */); }
        ...
        if (state & 8 /* Trailing */)
            { this.throwUnexpectedToken(); }
        return this.parseArrowFunctionExpression(context & ~16 /* Yield */ | 32 /* Await */, pos, args);
    }
    // We are done, so unset the bitmask
    this.flags &= ~1024 /* HaveSeenAwait */;
    this.errorLocation = undefined;
    return this.finishNode(pos, {
        type: 'CallExpression',
        callee: id,
...
Parser.prototype.parsePrimaryExpression = function parsePrimaryExpression (context, pos) {
    switch (this.token) {
        ...
        case 274519 /* FunctionKeyword */:
            return this.parseFunctionExpression(context & ~(16 /* Yield */ | 65536 /* Method */) | 64 /* InParenthesis */, pos);
...
Parser.prototype.parseLet = function parseLet (context) {
    ...
    if (this.flags & 2 /* HasUnicode */)
        { this.error(70 /* UnexpectedEscapedKeyword */); }
    if (context & 2 /* Strict */)
        { this.error(117 /* InvalidLetDeclBinding */); }
    this.nextToken(context);
    if (this.flags & 1 /* LineTerminator */ && !(this.flags & 32 /* Iteration */))
        { this.error(0 /* Unexpected */); }
...
Parser.prototype.parseClass = function parseClass (context, expr) {
    ...
    else if (!expr && !(context & 32768 /* OptionalIdentifier */)) {
        this.error(88 /* UnNamedClassStmt */);
    }
    if (this.parseEventually(context, 12372 /* ExtendsKeyword */)) {
...
Parser.prototype.parseClassFields = function parseClassFields (context, key, pos) {
    if (this.token === 1310749 /* Assign */) {
        key = this.parsePrivateProperty(context | 8388608 /* Fields */, pos, key);
    }
    this.parseEventually(context, 18 /* Comma */);
    return key;
};
Parser.prototype.parseClassElement = function parseClassElement (context, state) {
    ...
    if (state & 512 /* Static */) {
        if (state & 4096 /* Prototype */)
            { this.error(64 /* StaticPrototype */); }
        state &= ~1024 /* Constructor */;
    }
    if (state & 1024 /* Constructor */) {
        if (state & 51 /* Special */)
            { this.error(61 /* ConstructorSpecialMethod */); }
        if (context & 131072 /* HasConstructor */)
            { this.error(63 /* DuplicateConstructor */); }
    }
...
Parser.prototype.parseObjectExpression = function parseObjectExpression (context) {
    ...
    var pos = this.getLocations();
    this.expect(context, 393228 /* LeftBrace */);
    if (!(this.flags & 32768 /* SimpleParameterList */)) {
        this.flags |= 32768 /* SimpleParameterList */;
    }
    var properties = [];
    var firstProto;
    ...
    switch (this.token) {
        ...
        case 21 /* Colon */:
            ...
            if (!(state & 4 /* Computed */) && this.tokenValue === '__proto__') {
                if (firstProto)
                    { this.error(58 /* DuplicateProtoProperty */); }
                this.firstProto = true;
            }
            this.expect(context, 21 /* Colon */);
            if (context & 256 /* InAsyncArgs */ && this.token === 331885 /* AwaitKeyword */) {
                this.errorLocation = this.getLocations();
                this.flags |= 1024 /* HaveSeenAwait */;
            }
            value = this.parseAssignmentExpression(context);
            ...
            break;
        default:
            if (state & 51 /* Special */ || !this.isIdentifier(context, token)) {
                this.throwUnexpectedToken();
            }
            ...
            if (context & (524288 /* ForStatement */ | 64 /* InParenthesis */) &&
                context & 2 /* Strict */ && this.isEvalOrArguments(tokenValue)) {
                this.error(78 /* UnexpectedReservedWord */);
            }
            state |= 8 /* Shorthand */;
            if (this.token === 1310749 /* Assign */) {
...
Parser.prototype.parseRestElement = function parseRestElement (context) {
    var pos = this.getLocations();
    this.expect(context, 14 /* Ellipsis */);
    var argument = this.parseBindingPatternOrIdentifier(context);
    if (this.token === 1310749 /* Assign */)
        { this.error(1 /* UnexpectedToken */, tokenDesc(this.token)); }
    if (this.token !== 16 /* RightParen */)
...
Parser.prototype.parseThrowExpression = function parseThrowExpression (context) {
    if (!(this.flags & 8388608 /* OptionsNext */)) {
        this.error(108 /* UnsupportedFeature */, tokenDesc(this.token), 'next');
    }
    var pos = this.getLocations();
    this.nextToken(context);
    return this.finishNode(pos, {
...
Parser.prototype.parseArrayInitializer = function parseArrayInitializer (context) {
    ...
    while (this.token !== 20 /* RightBracket */) {
        if (this$1.parseEventually(context, 18 /* Comma */)) {
            elements.push(null);
        }
            ...
            if (this$1.token !== 20 /* RightBracket */) {
                this$1.errorLocation = this$1.getLocations();
                this$1.flags |= 2048 /* HaveSeenRest */;
                this$1.expect(context, 18 /* Comma */);
            }
...
Parser.prototype.parseParenthesizedExpression = function parseParenthesizedExpression (context) {
    ...
    this.expect(context, 262155 /* LeftParen */);
    var state = 0;
    if (this.parseEventually(context, 16 /* RightParen */)) {
        if (this.token === 10 /* Arrow */) {
            return this.parseArrowFunctionExpression(context & ~(32 /* Await */ | 16 /* Yield */), pos, []);
        }
        this.error(71 /* MissingArrowAfterParentheses */);
    }
    var expr;
    ...
    if (context & 16 /* Yield */ && !(state & 64 /* Yield */) && this.token === 282730 /* YieldKeyword */) {
        this.errorLocation = pos;
        this.flags |= 512 /* HaveSeenYield */;
    }
    ...
    if (this.token === 18 /* Comma */) {
        ...
        while (this.parseEventually(context, 18 /* Comma */)) {
            if (this$1.token === 16 /* RightParen */) {
                ...
                this$1.expect(context, 16 /* RightParen */);
                if (state & 4 /* Parenthesized */)
                    { this$1.error(72 /* InvalidParenthesizedPattern */); }
                return this$1.parseArrowFunctionExpression(context & ~(32 /* Await */ | 16 /* Yield */), pos, expressions);
            }
            else {
                if (context & 2 /* Strict */) {
    ...
    this.errorLocation = undefined;
    if (state & 16 /* Pattern */) {
        this.flags |= 65536 /* ParenthesizedPattern */;
    }
    return expr;
};
...
Parser.prototype.parseLiteral = function parseLiteral (context) {
    ...
    var value = this.tokenValue;
    var raw = this.tokenRaw;
    if (value === 'use strict' && !(this.flags & (2 /* HasUnicode */ | 8192 /* HasStrictDirective */))) {
        this.flags |= 8192 /* HasStrictDirective */;
    }
    this.nextToken(context);
    var node = this.finishNode(pos, {
        type: 'Literal',
...
Parser.prototype.validateLabel = function validateLabel (name) {
    if (this.labelSet === undefined || !('@' + name in this.labelSet)) {
        this.error(76 /* UnknownLabel */, name);
    }
};
...
Parser.prototype.parseAssignmentPattern = function parseAssignmentPattern (context, pos, pattern) {
        ...
        if ( pattern === void 0 ) pattern = this.parseBindingPatternOrIdentifier(context);
...
Parser.prototype.parseBindingIdentifier = function parseBindingIdentifier (context) {
    if (!this.isIdentifier(context, this.token))
        { this.throwUnexpectedToken(); }
    if (context & 402653184 /* Lexical */ && this.token === 8671304 /* LetKeyword */) {
        this.error(56 /* LetInLexicalBinding */);
    }
    var pos = this.getLocations();
    var name = this.tokenValue;
...
Parser.prototype.parseRestProperty = function parseRestProperty (context) {
    ...
    if (this.token !== 262145 /* Identifier */)
        { this.throwUnexpectedToken(); }
    var arg = this.parseBindingPatternOrIdentifier(context);
    if (this.token === 1310749 /* Assign */)
        { this.throwUnexpectedToken(); }
    return this.finishNode(pos, {
        type: 'RestElement',
...
Parser.prototype.parseDoExpression = function parseDoExpression (context) {
    if (!(this.flags & 134217728 /* OptionsV8 */)) {
        this.error(108 /* UnsupportedFeature */, tokenDesc(this.token), 'v8');
    }
    var pos = this.getLocations();
    this.expect(context, 12369 /* DoKeyword */);
...
Parser.prototype.parseJSXElement = function parseJSXElement (context) {
    ...
    if (!openingElement.selfClosing) {
        ...
        if (open !== close)
            { this.error(43 /* ExpectedJSXClosingTag */, close); }
    }
    return this.finishNode(pos, {
        type: 'JSXElement',
        children: children,
...
Parser.prototype.parseJSXElementName = function parseJSXElementName (context) {
    ...
    // Member expression
    while (this.parseEventually(context, 13 /* Period */)) {
