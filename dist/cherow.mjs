...
var isInOrOfKeyword = function (t) { return t === 2111281 /* InKeyword */ || t === 69746 /* OfKeyword */; };
...
var ErrorMessages = (_a = {}, _a[0 /* Unexpected */] = 'Unexpected token', _a[1 /* UnexpectedToken */] = 'Unexpected token \'%0\'', _a[2 /* UnterminatedComment */] = 'Unterminated comment', _a[3 /* UnterminatedString */] = 'Unterminated string literal', _a[4 /* UnterminatedRegExp */] = 'Unterminated regular expression literal', _a[5 /* UnicodeOutOfRange */] = 'Unicode escape code point out of range', _a[6 /* InvalidUnicodeEscapeSequence */] = 'Invalid Unicode escape sequence', _a[7 /* StrictOctalEscape */] = 'Octal escapes are not allowed in strict mode', _a[8 /* InvalidEightAndNine */] = 'Escapes \\8 or \\9 are not syntactically valid escapes', _a[9 /* StrictOctalLiteral */] = 'Octal literals are not allowed in strict mode', _a[10 /* MissingShebangExclamation */] = 'Missing exclamation in shebang', _a[11 /* DuplicateRegExpFlag */] = 'Duplicate regular expression flag %0', _a[12 /* UnexpectedTokenRegExp */] = 'Unexpected regular expression', _a[13 /* UnexpectedTokenRegExpFlag */] = 'Unexpected regular expression flag', _a[14 /* BadImportCallArity */] = 'Dynamic import must have one specifier as an argument', _a[15 /* StrictFunction */] = 'In strict mode code, functions can only be declared at top level or inside a block', _a[16 /* BadContinue */] = 'Continue must be inside loop or switch statement', _a[17 /* IllegalBreak */] = 'Unlabeled break must be inside loop or switch', _a[19 /* IllegalReturn */] = 'Illegal return statement', _a[18 /* MultipleDefaultsInSwitch */] = 'More than one default clause in switch statement', _a[20 /* NoCatchOrFinally */] = 'Missing catch or finally after try', _a[21 /* LineBreakAfterThrow */] = 'No line break is allowed between \'throw\' and its expression', _a[22 /* StrictModeWith */] = 'Strict mode code may not include a with statement', _a[23 /* BadGetterArity */] = 'Getter must not have any formal parameters', _a[24 /* BadSetterArity */] = 'Setter must have exactly one formal parameter', _a[25 /* BadSetterRestParameter */] = 'Setter function argument must not be a rest parameter', _a[26 /* IllegalUseStrict */] = 'Illegal \'use strict\' directive in function with non-simple parameter list', _a[27 /* ParameterAfterRestParameter */] = 'Rest parameter must be last formal parameter', _a[28 /* StrictFunctionName */] = 'Function name may not be eval or arguments in strict mode code', _a[29 /* MetaNotInFunctionBody */] = 'new.target only allowed within functions', _a[30 /* DeclarationMissingInitializer */] = 'Missing initializer in destructuring declaration', _a[32 /* InvalidLHSInForLoop */] = 'Invalid left-hand side in for-loop', _a[31 /* InvalidVarInitForOf */] = 'for-of loop variable declaration may not have an initializer', _a[34 /* InvalidLHSInForOf */] = 'Invalid left-hand side in for-of', _a[33 /* InvalidLHSInForIn */] = 'Invalid left-hand side in for-in', _a[35 /* StrictLHSAssignment */] = 'Eval or arguments can\'t be assigned to in strict mode code', _a[36 /* InvalidLHSInAssignment */] = 'Invalid left-hand side in assignment', _a[64 /* MissingArrowAfterParentheses */] = 'Missing => after parentheses', _a[37 /* NoAsAfterImportNamespace */] = 'Missing \'as\' keyword after import namespace', _a[38 /* InvalidModuleSpecifier */] = 'Invalid module specifier', _a[39 /* NonEmptyJSXExpression */] = 'JSX attributes must only be assigned a non-empty  \'expression\'', _a[40 /* ExpectedJSXClosingTag */] = 'Expected corresponding JSX closing tag for %0', _a[41 /* AdjacentJSXElements */] = 'Adjacent JSX elements must be wrapped in an enclosing tag', _a[42 /* InvalidBinaryDigit */] = 'Invalid binary digit', _a[43 /* InvalidOctalDigit */] = 'Invalid octal digit', _a[44 /* StrictDelete */] = 'Identifier expressions must not be deleted in strict mode', _a[45 /* StrictLHSPrefix */] = 'Prefix increment/decrement may not have eval or arguments operand in strict mode', _a[46 /* StrictLHSPostfix */] = 'Postfix increment/decrement may not have eval or arguments operand in strict mode', _a[48 /* ExportDeclAtTopLevel */] = 'Export declarations may only appear at top level of a module', _a[49 /* ImportDeclAtTopLevel */] = 'Import declarations may only appear at top level of a module', _a[50 /* MissingMsgDeclarationAfterExport */] = 'Missing declaration after \'export\' keyword', _a[51 /* ForAwaitNotOf */] = 'For await loop should be used with \'of\'', _a[52 /* LetInLexicalBinding */] = 'let is disallowed as a lexically bound name', _a[53 /* DuplicateProtoProperty */] = 'Property name __proto__ appears more than once in object literal', _a[54 /* StrictParamDupe */] = 'Duplicate argument names not allowed in this context', _a[55 /* InvalidHexEscapeSequence */] = 'Invalid hexadecimal escape sequence', _a[56 /* ConstructorSpecialMethod */] = 'Class constructor may not be an accessor', _a[57 /* BadSuperCall */] = 'super() is only valid in derived class constructors', _a[58 /* DuplicateConstructor */] = 'A class may only have one constructor', _a[59 /* StaticPrototype */] = 'Classes may not have static property named prototype', _a[62 /* LineBreakAfterAsync */] = 'No line break is allowed after async', _a[63 /* UnexpectedEscapedKeyword */] = 'Unexpected escaped keyword', _a[65 /* InvalidParenthesizedPattern */] = 'Invalid parenthesized pattern', _a[66 /* DuplicateIdentifier */] = '\'%0\' has already been declared ', _a[67 /* DuplicateBinding */] = 'Duplicate binding %0', _a[68 /* Redeclaration */] = 'Label \'%0\' has already been declared', _a[69 /* UnknownLabel */] = 'Undefined label \'%0\'', _a[70 /* UnexpectedReservedWord */] = 'Unexpected reserved word', _a[71 /* InvalidShorthandAssignment */] = 'Shorthand property assignments are valid only in destructuring patterns', _a[72 /* UnterminatedTemplate */] = 'Unterminated template literal', _a[73 /* UnexpectedStrictReserved */] = 'Unexpected eval or arguments in strict mode', _a[74 /* StrictParamName */] = 'The identifier \'eval\' or \'arguments\' must not be in binding position in strict mode', _a[75 /* DisallowedInContext */] = '\'%0\' may not be used as an identifier in this context', _a[76 /* IllegalArrowInParamList */] = 'Illegal arrow function parameter list', _a[77 /* UnexpectedBigIntLiteral */] = 'Unexpected BigInt literal', _a[78 /* UnNamedClassStmt */] = 'Class statement requires a name', _a[79 /* UnNamedFunctionStmt */] = 'Function statement requires a name', _a[80 /* InvalidStrictExpPostion */] = 'The identifier \'%0\' must not be in expression position in strict mode', _a[81 /* InvalidBindingStrictMode */] = 'The identifier \'%0\' must not be in binding position in strict mode', _a[82 /* MissingInitializer */] = 'Missing initializer', _a[83 /* InvalidVarDeclInForIn */] = 'Invalid variable declaration in for-in statement', _a[84 /* InvalidVarDeclInForOf */] = 'Invalid variable declaration in for-of statement', _a[85 /* UnexpectedNumber */] = 'Unexpected number', _a[86 /* UnexpectedSurrogate */] = 'Unexpected surrogate pair', _a[87 /* ForbiddenAsStatement */] = '%0 can\'t appear in single-statement context', _a[88 /* InvalidAsyncGenerator */] = 'Generator function or method can\'t be async', _a[89 /* InvalidArrowYieldParam */] = 'Arrow parameters must not contain yield expressions', _a[90 /* InvalidAwaitInArrowParam */] = '\'await\' is not allowed inside an async arrow\'s parameter list', _a[91 /* UnsupportedFeature */] = '%0 isn\'t supported by default. Enable the \'%1\' option to use them', _a[92 /* TemplateOctalLiteral */] = 'Template literals may not contain octal escape sequences', _a[93 /* InvalidNestedStatement */] = '%0  statement must be nested within an iteration statement', _a[94 /* InvalidGeneratorParam */] = 'Generator parameters must not contain yield expressions', _a[96 /* IllegalArrowFuncParamList */] = 'Illegal arrow function parameter list', _a[97 /* ReservedKeyword */] = 'The keyword %0 is reserved', _a[98 /* InvalidPrivateConstructor */] = 'Class constructor may not have a private field', _a[99 /* InvalidAwaitInAsyncFunc */] = 'Can not use await as identifier inside an async function', _a[100 /* NewTargetArrow */] = 'new.target must be within function (but not arrow expression) code', _a[101 /* UndefinedInClassScope */] = '\'%0\'  not defined in class scope', _a[102 /* InvalidComputedClassProperty */] = 'Invalid computed name in private property', _a[103 /* InvalidFieldConstructor */] = 'Classes may not have a private field named \'#constructor\'', _a[104 /* InvalidNumericSeparators */] = 'Numeric separators are not allowed here', _a[105 /* InvalidRestDefaultValue */] = 'Rest elements cannot have a default value', _a[106 /* InvalidBigIntLiteral */] = 'Invalid BigIntLiteral', _a[107 /* InvalidLhsInPostfixOp */] = 'Invalid left-hand side expression in postfix operation', _a[108 /* InvalidLhsInPrefixOp */] = 'Invalid left-hand side expression in prefix operation', _a[109 /* InvalidDestructuringTarget */] = 'Invalid destructuring assignment target', _a[110 /* UnterminatedEscape */] = 'Unterminated escape in regular expression', _a[115 /* AsyncFunctionInSingleStatementContext */] = 'Async functions can only be declared at the top level or inside a block', _a[114 /* InvalidRegExpGroup */] = 'Generators can only be declared at the top level or inside a block', _a[117 /* SloppyFunction */] = 'In non-strict mode code, functions can only be declared at top level, inside a block, or as the body of an if statement', _a[118 /* YieldInParameter */] = 'Yield expression not allowed in formal parameter', _a);
...
var Parser = /** @class */ (function () {
    ...
    Parser.prototype.parseProgram = function (context) {
    ...
    Parser.prototype.error = function (type) {
        var params = [];
    ...
    Parser.prototype.saveState = function () {
        return {
            index: this.index,
            column: this.column,
            line: this.line,
    ...
    Parser.prototype.rewindState = function (state) {
    ...
    Parser.prototype.nextToken = function (context) {
    ...
    Parser.prototype.storeRaw = function (start) {
        this.tokenRaw = this.source.slice(start, this.index);
    };
    Parser.prototype.scanNext = function (err) {
        if (err === void 0) { err = 3 /* UnterminatedString */; }
        this.advance();
        if (!this.hasNext())
            this.error(err);
        return this.nextCodePoint();
    };
    Parser.prototype.nextCodePoint = function () {
    ...
    Parser.prototype.consume = function (code) {
        if (this.nextChar() !== code)
            return false;
        this.advance();
        return true;
    };
    Parser.prototype.advanceNewline = function (state) {
        if (state === void 0) { state = 0 /* None */; }
     ...
     */
    Parser.prototype.scan = function (context) {
        ...
        while (this.hasNext()) {
            ...
            var first = this.nextChar();
            if (first >= 128)
                first = this.nextCodePoint();
            switch (first) {
                ...
                case 47 /* Slash */:
                    {
                        ...
                        else if (this.consume(42 /* Asterisk */)) {
                            this.skipBlockComment();
                            continue;
                        }
                        else if (this.consume(61 /* EqualSign */)) {
                            ...
                            case 33 /* Exclamation */:
                                {
                                    ...
                                    if (this.consume(45 /* Hyphen */) && this.consume(45 /* Hyphen */)) {
                                        this.skipSingleLineComment();
                                        continue;
                                    }
                                }
                ...
                case 45 /* Hyphen */:
                    {
                        ...
                        switch (this.nextChar()) {
                            case 45 /* Hyphen */:
                                {
                                    this.advance();
                                    if (this.nextChar() === 62 /* GreaterThan */ &&
                ...
                case 46 /* Period */:
                    {
                        ...
                        if (next === 46 /* Period */) {
                            ...
                            if (index < this.source.length &&
                                this.source.charCodeAt(index) === 46 /* Period */) {
                                this.index = index + 1;
                                this.column += 3;
                                return 14 /* Ellipsis */;
                            }
                ...
                default:
                    ...
                    this.error(1 /* UnexpectedToken */, fromCodePoint(first));
            }
        }
        return 0 /* EndOfSource */;
    };
    Parser.prototype.skipSingleLineComment = function () {
            ...
            switch (ch) {
                ...
                case 42 /* Asterisk */:
                    if (this.index + 1 < this.source.length &&
                        this.source.charCodeAt(this.index + 1) === 47 /* Slash */) {
                        this.index += 2;
                        this.column += 2;
                        state |= 32 /* Terminated */;
                        break scan;
    ...
    Parser.prototype.addComment = function (type, value) {
        var comment = {
            type: type,
            value: value,
    ...
    // TODO! Optimize
    Parser.prototype.attachComment = function (context, node) {
        ...
        if (lastChild) {
            ...
            if (this.leadingComments[this.leadingComments.length - 1].end <= node.start) {
                ...
                for (firstIndex = 0; firstIndex !== this.leadingComments.length; firstIndex++) {
                    if (this.leadingComments[firstIndex].end > node.start)
                        break;
                }
    ...
    Parser.prototype.scanIdentifier = function (context, hasUnicode) {
        ...
        loop: while (this.hasNext()) {
            ...
            switch (ch) {
                case 92 /* Backslash */:
                    ...
                    var code = this.peekUnicodeEscape();
                    if (!(code >= 0))
     ...
     * Peek unicode escape
     */
    Parser.prototype.peekUnicodeEscape = function () {
        var code = -1;
        var index = this.index;
    ...
    Parser.prototype.peekExtendedUnicodeEscape = function () {
        var ch = this.nextChar();
        var code = 0;
        // '\u{DDDDDDDD}'
        if (ch === 123 /* LeftBrace */) {
    ...
    Parser.prototype.scanNumericFragment = function (state) {
    ...
    Parser.prototype.scanDecimalDigitsOrFragment = function () {
        var start = this.index;
        var state = 0;
        var ret = '';
    ...
    Parser.prototype.scanNumber = function (context, ch) {
        var start = this.index;
        var state = 0;
        var value;
        var next = this.flags & 33554432;
    ...
    Parser.prototype.scanRegularExpression = function () {
        ...
        loop: while (true) {
            ...
            if (!this.hasNext())
                this.error(4 /* UnterminatedRegExp */);
        }
        var bodyEnd = this.index - 1; // drop the slash from the slice
        var flagsStart = this.index;
        var mask = 0;
        loop: while (this.hasNext()) {
            var code = this.nextChar();
            switch (code) {
                case 103 /* LowerG */:
                    if (mask & 2 /* Global */)
                        this.error(11 /* DuplicateRegExpFlag */, 'g');
                    mask |= 2 /* Global */;
                    break;
                case 105 /* LowerI */:
                    if (mask & 1 /* IgnoreCase */)
                        this.error(11 /* DuplicateRegExpFlag */, 'i');
                    mask |= 1 /* IgnoreCase */;
                    break;
                case 109 /* LowerM */:
                    if (mask & 4 /* Multiline */)
                        this.error(11 /* DuplicateRegExpFlag */, 'm');
                    mask |= 4 /* Multiline */;
                    break;
                case 117 /* LowerU */:
                    if (mask & 8 /* Unicode */)
                        this.error(11 /* DuplicateRegExpFlag */, 'u');
                    mask |= 8 /* Unicode */;
                    break;
                case 121 /* LowerY */:
                    if (mask & 16 /* Sticky */)
                        this.error(11 /* DuplicateRegExpFlag */, 'y');
                    mask |= 16 /* Sticky */;
                    break;
                // Stage 3 proposal
                case 115 /* LowerS */:
                    if (this.flags & 33554432 /* OptionsNext */) {
                        if (mask & 32 /* DotAll */)
                            this.error(11 /* DuplicateRegExpFlag */, 's');
                        mask |= 32 /* DotAll */;
                        break;
                    }
                default:
                    if (!isIdentifierPart(code))
                        break loop;
                    this.error(13 /* UnexpectedTokenRegExpFlag */);
            }
            this.advance();
        }
    ...
    Parser.prototype.testRegExp = function (pattern, flags, mask) {
        try {
    ...
    Parser.prototype.scanString = function (context, quote) {
        var ret = '';
        var hasEscape = false;
            ...
            switch (ch) {
                ...
                case 92 /* Backslash */:
                    ...
                    if (ch >= 128) {
                        ...
                        var code = this.scanEscape(context, ch);
                        if (code >= 0) {
                            ret += fromCodePoint(code);
                        }
                        else {
    ...
    Parser.prototype.throwStringError = function (context, code) {
        switch (code) {
            case -2 /* StrictOctal */:
    ...
    Parser.prototype.scanEscape = function (context, cp) {
        switch (cp) {
            case 98 /* LowerB */:
                return 8 /* Backspace */;
            case 102 /* LowerF */:
    ...
    Parser.prototype.consumeTemplateBrace = function (context) {
        if (!this.hasNext())
    ...
    Parser.prototype.scanTemplate = function (context) {
        var start = this.index;
        ...
        loop: while (ch !== 96 /* Backtick */) {
            switch (ch) {
                ...
                case 92 /* Backslash */:
                    ch = this.scanNext(72 /* UnterminatedTemplate */);
                    if (ch >= 128) {
                        ret += fromCodePoint(ch);
                    }
                    else {
                        this.lastChar = ch;
                        var code = this.scanEscape(context | 2 /* Strict */, ch);
                        if (code >= 0) {
                            ret += fromCodePoint(code);
                        }
                            ...
                            this.throwStringError(context | 524288 /* Template */, code);
                        }
                    }
                    break;
                // Line terminators
    ...
    Parser.prototype.scanLooserTemplateSegment = function (ch) {
    ...
    Parser.prototype.parseModuleItemList = function (context) {
        var statements = [];
        while (this.token !== 0 /* EndOfSource */) {
            statements.push(this.token === 262147 /* StringLiteral */ ?
                this.parseDirective(context) :
                this.parseModuleItem(context | 4 /* AllowIn */));
        }
        return statements;
    };
    Parser.prototype.parseDirective = function (context) {
    ...
    Parser.prototype.parseStatementList = function (context, endToken) {
        var statements = [];
        while (this.token === 262147 /* StringLiteral */) {
            var item = this.parseDirective(context);
            ...
            if (this.flags & 524288 /* StrictDirective */) {
                ...
                if (this.flags & 8192 /* SimpleParameterList */)
                    this.error(26 /* IllegalUseStrict */);
                if (this.flags & 1024 /* Binding */)
                    this.error(73 /* UnexpectedStrictReserved */);
                context |= 2 /* Strict */;
            }
        }
    ...
    Parser.prototype.getLocations = function () {
        return {
            index: this.index,
            start: this.startIndex,
            line: this.startLine,
    ...
    Parser.prototype.finishNode = function (context, pos, node, shouldAdvance, root) {
    ...
    Parser.prototype.parseOptional = function (context, t) {
        if (this.token !== t)
            return false;
        this.nextToken(context);
        return true;
    };
    Parser.prototype.expect = function (context, t, msg) {
        if (msg === void 0) { msg = 0 /* Unexpected */; }
        if (this.token !== t)
            this.error(msg);
        this.nextToken(context);
    };
    Parser.prototype.isEvalOrArguments = function (value) {
        return value === 'eval' || value === 'arguments';
    };
    /**
     * Consume a semicolon between tokens, optionally inserting it if necessary.
     */
    Parser.prototype.consumeSemicolon = function (context) {
        switch (this.token) {
            case 17 /* Semicolon */:
    ...
    // 'import', 'import.meta'
    Parser.prototype.nextTokenIsLeftParenOrPeriod = function (context) {
    ...
    Parser.prototype.nextTokenIsFuncKeywordOnSameLine = function (context) {
        var savedState = this.saveState();
        var t = this.nextToken(context);
        var line = this.line;
        this.rewindState(savedState);
    ...
    Parser.prototype.isLexical = function (context) {
        var savedState = this.saveState();
    ...
    Parser.prototype.isIdentifier = function (context, t) {
        if (context & 2 /* Strict */) {
    ...
    Parser.prototype.parseIdentifierName = function (context, t) {
        if (t & (67108864 /* IsIdentifier */ | 4096 /* Keyword */))
            return this.parseIdentifier(context);
        this.error(1 /* UnexpectedToken */, tokenDesc(t));
    };
    Parser.prototype.parseExportDefault = function (context, pos) {
    ...
    Parser.prototype.parseExportDeclaration = function (context) {
        var pos = this.getLocations();
        var specifiers = [];
        var source = null;
    ...
    Parser.prototype.parseNamedExportDeclaration = function (context) {
        var pos = this.getLocations();
    ...
    Parser.prototype.parseExportAllDeclaration = function (context, pos) {
    ...
    Parser.prototype.parseFromClause = function (context) {
    ...
    // import {<foo as bar>} ...;
    Parser.prototype.parseImportSpecifier = function (context) {
        var pos = this.getLocations();
    ...
    // {foo, bar as bas}
    Parser.prototype.parseNamedImport = function (context, specifiers) {
        this.expect(context, 393228 /* LeftBrace */);
        while (this.token !== 15 /* RightBrace */) {
    ...
    // import <* as foo> ...;
    Parser.prototype.parseImportNamespaceSpecifier = function (context, specifiers) {
        var pos = this.getLocations();
    ...
    // import <foo> ...;
    Parser.prototype.parseImportDefaultSpecifier = function (context) {
        return this.finishNode(context, this.getLocations(), {
            type: 'ImportDefaultSpecifier',
            local: this.parseIdentifierName(context, this.token)
        });
    };
    Parser.prototype.parseImportDeclaration = function (context) {
        var pos = this.getLocations();
    ...
    Parser.prototype.parseImportClause = function (context) {
        var specifiers = [];
        switch (this.token) {
    ...
    Parser.prototype.parseModuleItem = function (context) {
        switch (this.token) {
            // 'export'
    ...
    Parser.prototype.parseStatementListItem = function (context) {
        switch (this.token) {
            case 274519 /* FunctionKeyword */:
    ...
    Parser.prototype.parseStatement = function (context) {
        switch (this.token) {
            case 67371009 /* Identifier */:
    ...
    Parser.prototype.parseBlockStatement = function (context) {
        var pos = this.getLocations();
        var body = [];
        this.expect(context, 393228 /* LeftBrace */);
        if (this.token !== 15 /* RightBrace */) {
            ...
            var flag = this.flags;
            while (this.token !== 15 /* RightBrace */) {
                body.push(this.parseStatementListItem(context & ~2048 /* ExistingScope */ | 1024 /* Declaration */));
            }
            this.flags = flag;
    ...
    Parser.prototype.parseTryStatement = function (context) {
        var pos = this.getLocations();
    ...
    Parser.prototype.parseCatchClause = function (context) {
        var pos = this.getLocations();
    ...
    Parser.prototype.parseThrowStatement = function (context) {
        var pos = this.getLocations();
    ...
    Parser.prototype.parseWithStatement = function (context) {
        var pos = this.getLocations();
    ...
    Parser.prototype.parseWhileStatement = function (context) {
        var pos = this.getLocations();
    ...
    Parser.prototype.parseDoWhileStatement = function (context) {
        var pos = this.getLocations();
    ...
    Parser.prototype.parseContinueStatement = function (context) {
    ...
    Parser.prototype.parseBreakStatement = function (context) {
        var pos = this.getLocations();
    ...
    Parser.prototype.parseForStatement = function (context) {
        var pos = this.getLocations();
    ...
    Parser.prototype.parseIfStatementChild = function (context) {
    ...
    Parser.prototype.parseIfStatement = function (context) {
        var pos = this.getLocations();
    ...
    Parser.prototype.parseDebuggerStatement = function (context) {
        var pos = this.getLocations();
    ...
    Parser.prototype.parseSwitchStatement = function (context) {
        var pos = this.getLocations();
        ...
        while (this.token !== 15 /* RightBrace */) {
            var clause = this.parseSwitchCases(context);
            if (clause.test === null) {
                // Error on duplicate 'default' clauses
                if (seenDefault)
                    this.error(18 /* MultipleDefaultsInSwitch */);
                seenDefault = true;
            }
            cases.push(clause);
        }
    ...
    Parser.prototype.parseSwitchCases = function (context) {
        var pos = this.getLocations();
        var test = null;
    ...
    Parser.prototype.parseEmptyStatement = function (context) {
        var pos = this.getLocations();
        this.nextToken(context);
        return this.finishNode(context, pos, {
            type: 'EmptyStatement'
    ...
    Parser.prototype.canParseArgument = function () {
    ...
    Parser.prototype.parseReturnStatement = function (context) {
        var pos = this.getLocations();
    ...
    Parser.prototype.parseExpressionOrLabeledStatement = function (context) {
        var pos = this.getLocations();
    ...
    Parser.prototype.parseExpressionStatement = function (context) {
        var pos = this.getLocations();
    ...
    Parser.prototype.parseVariableStatement = function (context) {
        var pos = this.getLocations();
        var t = this.token;
        if (this.flags & 2 /* ExtendedUnicodeEscape */)
            this.error(63 /* UnexpectedEscapedKeyword */);
    ...
    Parser.prototype.parseVariableDeclarationList = function (context) {
    ...
    Parser.prototype.parseExpression = function (context, pos) {
    ...
    Parser.prototype.parseYieldExpression = function (context, pos) {
        if (this.flags & 2 /* ExtendedUnicodeEscape */)
            this.error(63 /* UnexpectedEscapedKeyword */);
    ...
    Parser.prototype.parseAssignmentExpression = function (context) {
        var pos = this.getLocations();
    ...
    Parser.prototype.reinterpretAsPattern = function (context, node) {
        switch (node.type) {
            case 'Identifier':
            ...
            case 'ArrayPattern':
                for (var i = 0; i < node.elements.length; ++i) {
                    ...
                    if (node.elements[i] !== null)
                        this.reinterpretAsPattern(context, node.elements[i]);
                }
                return;
            case 'Property':
    ...
    Parser.prototype.parseArrowFunctionExpression = function (context, pos, params) {
        ...
        if (!(context & 8 /* Arrow */)) {
            for (var i in params)
                this.reinterpretAsPattern(context | 512 /* InArrowParameterList */, params[i]);
        }
        var body;
    ...
    Parser.prototype.parseConditionalExpression = function (context, pos) {
    ...
    Parser.prototype.parseBinaryExpression = function (context, minPrec, pos, expr) {
        ...
        while (hasMask(this.token, 2097152 /* BinaryOperator */)) {
            ...
            if (!bit && this.token === 2111281 /* InKeyword */)
                break;
    ...
    Parser.prototype.isPrivateName = function (expr) {
    ...
    Parser.prototype.parseAwaitExpression = function (context, pos) {
        if (this.flags & 2 /* ExtendedUnicodeEscape */)
            this.error(63 /* UnexpectedEscapedKeyword */);
    ...
    Parser.prototype.parseUpdateExpression = function (context, pos) {
        var expr;
        var hasPrefix;
        var t = this.token;
    ...
    Parser.prototype.parseSuper = function (context) {
        var pos = this.getLocations();
    ...
    Parser.prototype.parseImportCall = function (context, pos) {
    ...
    Parser.prototype.parseLeftHandSideExpression = function (context, pos) {
    ...
    Parser.prototype.parseMemberExpression = function (context, pos, expr) {
        ...
        while (true) {
            switch (this.token) {
                ...
                case 13 /* Period */:
                    {
                        ...
                        var property = context & 32768 /* Method */ && this.flags & 33554432 /* OptionsNext */ && this.token === 117 /* Hash */ ?
                ...
                case 393235 /* LeftBracket */:
                    {
                        ...
                        var start = this.getLocations();
                        var property = this.parseExpression(context | 4 /* AllowIn */, start);
                ...
                case 262153 /* TemplateTail */:
                    {
                        var quasiStart = this.getLocations();
                        var quasi = this.token === 262152 /* TemplateCont */ ?
                            this.parseTemplate(context | 1048576 /* TaggedTemplate */, quasiStart) : this.parseTemplateLiteral(context | 1048576 /* TaggedTemplate */, quasiStart);
    ...
    Parser.prototype.parseCallExpression = function (context, pos, expr) {
        while (true) {
            expr = this.parseMemberExpression(context, pos, expr);
            if (this.token !== 262155 /* LeftParen */)
                return expr;
            var args = this.parseArguments(context);
            if (context & 8192 /* Import */ && args.length !== 1 &&
                expr.type === 'Import')
                this.error(14 /* BadImportCallArity */);
            expr = this.finishNode(context, pos, {
                type: 'CallExpression',
                callee: expr,
                arguments: args
    ...
    Parser.prototype.parseFunctionDeclaration = function (context) {
        var prevContext = context;
        return this.parseFunction(context & ~(16 /* Yield */ | 32 /* Await */), prevContext);
    };
    Parser.prototype.parseFunctionExpression = function (context) {
        return this.parseFunction(context & ~16 /* Yield */);
    };
    Parser.prototype.parseFunction = function (context, prevContext) {
        if (prevContext === void 0) { prevContext = 0 /* None */; }
        var pos = this.getLocations();
        var t = this.token;
    ...
    Parser.prototype.parseParameterList = function (context, state) {
        this.expect(context, 262155 /* LeftParen */);
        var result = [];
        this.flags &= ~8192 /* SimpleParameterList */;
        while (this.token !== 16 /* RightParen */) {
            ...
            if (!(context & 2 /* Strict */) && !(this.token & 67108864 /* IsIdentifier */))
    ...
    Parser.prototype.parseFormalParameters = function (context) {
        var pos = this.getLocations();
    ...
    Parser.prototype.parseAsyncFunctionExpression = function (context, pos) {
    ...
    Parser.prototype.parseAsyncArguments = function (context, pos, id, flags, hasEscape) {
        ...
        while (this.token !== 16 /* RightParen */) {
            if (this.token === 14 /* Ellipsis */) {
                var elem = this.parseSpreadExpression(context);
                ...
                if (this.token & 1073741824 /* IsAwait */ && !(state & 2 /* Await */)) {
                    this.errorLocation = this.getLocations();
                    state |= 2 /* Await */;
                }
                ...
                args.push(this.parseAssignmentExpression(context | 256 /* InAsyncArgs */));
            }
            if (this.token === 16 /* RightParen */)
                break;
            this.expect(context, 18 /* Comma */);
    ...
    Parser.prototype.parseSpreadExpression = function (context, pos) {
    ...
    Parser.prototype.parseArguments = function (context) {
        var pos = this.getLocations();
        this.expect(context, 262155 /* LeftParen */);
        var args = [];
        while (this.token !== 16 /* RightParen */) {
            var expr = this.token === 14 /* Ellipsis */ ? this.parseSpreadExpression(context) :
    ...
    Parser.prototype.parseMetaProperty = function (context, meta, pos) {
        return this.finishNode(context, pos, {
            meta: meta,
            type: 'MetaProperty',
    ...
    Parser.prototype.parseNewExpression = function (context) {
        var pos = this.getLocations();
    ...
    Parser.prototype.parsePrimaryExpression = function (context, pos) {
        switch (this.token) {
    ...
    Parser.prototype.validateClassFields = function () {
            ...
            for (var i = 0; i < this.fieldSet.length; i++) {
                ...
                if (mask & 2 /* Scope */) {
                    if (scope === undefined)
                        ...
                        this.error(67 /* DuplicateBinding */, '#' + key);
                    scope[key] = true;
                }
            }
    ...
    Parser.prototype.parseClassDeclaration = function (context) {
        var pos = this.getLocations();
        var id = null;
    ...
    Parser.prototype.parseClassExpression = function (context) {
        var pos = this.getLocations();
        this.expect(context, 274509 /* ClassKeyword */);
        var id = null;
        if (this.isIdentifier(context, this.token)) {
    ...
    Parser.prototype.parseClassTail = function (context, id, pos) {
        var superClass = null;
        var flags = 0;
    ...
    Parser.prototype.parseClassElementList = function (context, flags) {
        var body = [];
        while (this.token !== 15 /* RightBrace */) {
            if (!this.parseOptional(context, 17 /* Semicolon */)) {
                var node = this.parseClassElement(context, flags);
                body.push(node);
    ...
    Parser.prototype.parseClassBody = function (context, flags) {
        var pos = this.getLocations();
    ...
    Parser.prototype.parsePrivateProperty = function (context, key) {
        var pos = this.getLocations();
    ...
    Parser.prototype.parseClassPrivateProperty = function (context, state, pos) {
        if (pos === void 0) { pos = this.getLocations(); }
    ...
    Parser.prototype.parsePrivateName = function (context) {
        var pos = this.getLocations();
        this.expect(context, 117 /* Hash */);
        if (this.fieldSet === undefined) {
            this.errorLocation = pos;
    ...
    Parser.prototype.parseClassElement = function (context, state) {
        var pos = this.getLocations();
        if (!(context & 1 /* Module */) &&
    ...
    Parser.prototype.parsePropertyName = function (context, pos) {
        switch (this.token) {
            case 262146 /* NumericLiteral */:
            case 262147 /* StringLiteral */:
                return this.parseLiteral(context);
    ...
    Parser.prototype.parseObjectElement = function (context) {
        var pos = this.getLocations();
        var t = this.token;
    ...
    Parser.prototype.parseMethodDefinition = function (context, state) {
        var pos = this.getLocations();
    ...
    Parser.prototype.parseRestElement = function (context) {
        var pos = this.getLocations();
        this.expect(context, 14 /* Ellipsis */);
    ...
    Parser.prototype.parseThrowExpression = function (context, pos) {
        if (!(this.flags & 33554432 /* OptionsNext */)) {
    ...
    Parser.prototype.parseArrayInitializer = function (context) {
        var pos = this.getLocations();
        this.expect(context, 393235 /* LeftBracket */);
        var elements = [];
        while (this.token !== 20 /* RightBracket */) {
            if (this.parseOptional(context, 18 /* Comma */)) {
                ...
                var element = this.parseSpreadExpression(context);
                ...
                elements.push(this.parseAssignmentExpression(context | 4 /* AllowIn */));
                if (this.token !== 20 /* RightBracket */) {
                    this.expect(context, 18 /* Comma */);
                }
            }
    ...
    Parser.prototype.parseParenthesizedExpression = function (context, pos) {
        this.expect(context, 262155 /* LeftParen */);
        var state = 0;
        ...
        if (this.token === 18 /* Comma */) {
            ...
            while (this.parseOptional(context, 18 /* Comma */)) {
                if (this.token === 16 /* RightParen */) {
                    ...
                    this.expect(context, 16 /* RightParen */);
                    if (this.token === 10 /* Arrow */)
                        return this.parseArrowFunctionExpression(context & ~(32 /* Await */ | 16 /* Yield */), pos, expressions);
                }
                else if (this.token === 14 /* Ellipsis */) {
    ...
    Parser.prototype.parseRegularExpression = function (context) {
    ...
    Parser.prototype.parseTemplateLiteral = function (context, pos) {
        return this.finishNode(context, pos, {
    ...
    Parser.prototype.parseTemplateHead = function (context, cooked, raw) {
        var pos = this.getLocations();
    ...
    Parser.prototype.parseTemplateElement = function (context) {
        var pos = this.getLocations();
    ...
    Parser.prototype.parseTaggedTemplateExpression = function (context, expr, quasi, pos) {
        return this.finishNode(context, pos, {
    ...
    Parser.prototype.parseTemplate = function (context, pos, expressions, quasis) {
    ...
    Parser.prototype.parseBigIntLiteral = function (context, pos) {
        var value = this.tokenValue;
        var raw = this.tokenRaw;
        var node = this.finishNode(context, pos, {
            type: 'Literal',
    ...
    Parser.prototype.parseNullOrTrueOrFalseExpression = function (context, pos) {
        if (this.flags & 2 /* ExtendedUnicodeEscape */)
            this.error(63 /* UnexpectedEscapedKeyword */);
        var t = this.token;
        var raw = tokenDesc(t);
    ...
    Parser.prototype.parseThisExpression = function (context) {
        var pos = this.getLocations();
        return this.finishNode(context, pos, {
            type: 'ThisExpression'
        }, true);
    };
    Parser.prototype.parseIdentifier = function (context) {
        var name = this.tokenValue;
        var pos = this.getLocations();
    ...
    Parser.prototype.addCatchArg = function (name, type) {
        if (type === void 0) { type = 1 /* Shadowable */; }
        this.initBlockScope();
        this.blockScope[name] = type;
    };
    Parser.prototype.initBlockScope = function () {
    ...
    Parser.prototype.initFunctionScope = function () {
    ...
    Parser.prototype.addFunctionArg = function (name) {
    ...
    Parser.prototype.addVarOrBlock = function (context, name) {
    ...
    Parser.prototype.addVarName = function (name) {
    ...
    Parser.prototype.parseAssignmentPattern = function (context, pos, pattern) {
        if (pos === void 0) { pos = this.getLocations(); }
    ...
    Parser.prototype.parseBindingIdentifierOrPattern = function (context) {
        switch (this.token) {
            case 393235 /* LeftBracket */:
    ...
    Parser.prototype.parseBindingIdentifier = function (context) {
        var t = this.token;
        if (!this.isIdentifier(context, t)) {
            this.error(1 /* UnexpectedToken */, tokenDesc(t));
        }
    ...
    Parser.prototype.parseAssignmentRestElement = function (context) {
        var pos = this.getLocations();
        this.expect(context, 14 /* Ellipsis */);
        var argument = this.parseBindingIdentifierOrPattern(context);
        if (this.token === 1310749 /* Assign */)
    ...
    Parser.prototype.parseArrayElementsBindingPattern = function (context) {
        var pos = this.getLocations();
        this.expect(context, 393235 /* LeftBracket */);
        var elements = [];
        while (this.token !== 20 /* RightBracket */) {
            if (this.parseOptional(context, 18 /* Comma */)) {
                ...
                elements.push(this.parseAssignmentPattern(context | 4 /* AllowIn */));
                if (this.token !== 20 /* RightBracket */)
                    this.expect(context, 18 /* Comma */);
            }
        }
    ...
    Parser.prototype.parseComputedPropertyName = function (context, pos) {
        this.expect(context, 393235 /* LeftBracket */);
    ...
    Parser.prototype.ObjectAssignmentPattern = function (context) {
        var pos = this.getLocations();
        var properties = [];
        this.expect(context, 393228 /* LeftBrace */);
        while (this.token !== 15 /* RightBrace */) {
    ...
    Parser.prototype.parseRestProperty = function (context) {
        var pos = this.getLocations();
        this.expect(context, 14 /* Ellipsis */);
        if (!(this.token & 67108864 /* IsIdentifier */))
            this.error(1 /* UnexpectedToken */, tokenDesc(this.token));
    ...
    Parser.prototype.parseAssignmentProperty = function (context) {
        var pos = this.getLocations();
        var state = 0;
        var key;
        var value;
    ...
    /** JSX */
    Parser.prototype.parseJSXChildren = function (context) {
        var children = [];
        while (this.token !== 25 /* JSXClose */) {
            children.push(this.parseJSXChild(context | 8388608 /* Expression */, this.getLocations()));
        }
        return children;
    };
    Parser.prototype.parseJSXChild = function (context, pos) {
        switch (this.token) {
            case 116 /* JSXText */:
            case 67371009 /* Identifier */:
    ...
    Parser.prototype.parseJSXSpreadChild = function (context) {
        var pos = this.getLocations();
        this.expect(context, 14 /* Ellipsis */);
    ...
    Parser.prototype.parseJSXText = function (context) {
        var pos = this.getLocations();
    ...
    Parser.prototype.parseJSXEmptyExpression = function (context, pos) {
        return this.finishNode(context, pos, {
            type: 'JSXEmptyExpression'
        });
    };
    Parser.prototype.parseJSXExpressionContainer = function (context) {
        var pos = this.getLocations();
        this.expect(context, 393228 /* LeftBrace */);
        if (this.token === 14 /* Ellipsis */) {
    ...
    Parser.prototype.parseJSXClosingElement = function (context, isFragment) {
        var pos = this.getLocations();
    ...
    Parser.prototype.scanJSXString = function (quote) {
        var ret = '';
        this.advance();
        var ch = this.nextChar();
        while (ch !== quote) {
    ...
    Parser.prototype.scanJSXAttributeValue = function (context) {
        this.startIndex = this.index;
        this.startColumn = this.column;
        this.startLine = this.line;
        var ch = this.nextChar();
    ...
    Parser.prototype.parseJSXSpreadAttribute = function (context) {
        var pos = this.getLocations();
        this.expect(context, 393228 /* LeftBrace */);
        this.expect(context, 14 /* Ellipsis */);
        var expression = this.parseExpression(context, pos);
    ...
    Parser.prototype.parseJSXAttributeName = function (context) {
        var pos = this.getLocations();
    ...
    Parser.prototype.parseJSXAttribute = function (context) {
        var pos = this.getLocations();
        var value = null;
    ...
    Parser.prototype.parseJSXExpressionAttribute = function (context) {
        var pos = this.getLocations();
        this.expect(context, 393228 /* LeftBrace */);
    ...
    Parser.prototype.parseJSXAttributes = function (context) {
        var attributes = [];
        while (!(this.token === 2099008 /* GreaterThan */ || this.token === 2361909 /* Divide */)) {
            if (this.token === 393228 /* LeftBrace */) {
                attributes.push(this.parseJSXSpreadAttribute(context &= ~8388608 /* Expression */));
            }
            else {
    ...
    Parser.prototype.nextJSXToken = function () {
    ...
    Parser.prototype.parseJSXIdentifier = function (context) {
        var name = this.tokenValue;
        var pos = this.getLocations();
        this.nextToken(context);
        return this.finishNode(context, pos, {
    ...
    Parser.prototype.parseJSXNamespacedName = function (context, namespace, pos) {
        this.expect(context, 21 /* Colon */);
    ...
    Parser.prototype.parseJSXMemberExpression = function (context, expr, pos) {
        return this.finishNode(context, pos, {
    ...
    Parser.prototype.parseJSXElementName = function (context) {
        var pos = this.getLocations();
    ...
    Parser.prototype.parseJSXElement = function (context) {
        var pos = this.getLocations();
