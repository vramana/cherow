...
ErrorMessages[101 /* InvalidWithBody */] = 'The body of a with statement must not be a labeled function declaration';
ErrorMessages[102 /* InvalidGeneratorParam */] = 'Generator parameters must not contain yield expressions';
ErrorMessages[104 /* IllegalArrowFuncParamList */] = 'Illegal arrow function parameter list';
ErrorMessages[105 /* ReservedKeyword */] = 'The keyword %0 is reserved';
ErrorMessages[106 /* InvalidPrivateConstructor */] = 'Class constructor may not have a private field';
ErrorMessages[107 /* InvalidAwaitInAsyncFunc */] = 'Can not use await as identifier inside an async function';
ErrorMessages[108 /* NewTargetArrow */] = 'new.target must be within function (but not arrow expression) code';
ErrorMessages[109 /* UndefinedInClassScope */] = '\'%0\'  not defined in class scope';
ErrorMessages[110 /* InvalidComputedClassProperty */] = 'Invalid computed name in private property';
        ...
        switch (this$1.nextChar()) {
            case 95 /* Underscore */:
                ...
                if (allowSeparator) {
                    ...
                    result += this$1.source.substring(start, this$1.index);
                }
                else {
...
Parser.prototype.scanNumericFragment = function scanNumericFragment (separatorAllowed) {
...
Parser.prototype.scanNumber = function scanNumber (context, ch) {
    ...
    if (ch === 48 /* Zero */) {
        ...
        switch (ch) {
            ...
            case 88 /* UpperX */:
                {
                    ...
                    while (this.hasNext()) {
                        ...
                        if (ch === 95 /* Underscore */) {
                            ...
                            separatorAllowed = this$1.scanNumericFragment(separatorAllowed);
                            continue;
                        }
                        var digit = toHex(ch);
                        if (digit < 0)
            ...
            case 79 /* UpperO */:
                {
                    ...
                    while (this.hasNext()) {
                        ...
                        if (ch === 95 /* Underscore */) {
                            state |= 256 /* ContainsFragment */;
                            separatorAllowed$1 = this$1.scanNumericFragment(separatorAllowed$1);
                            continue;
                        }
                        separatorAllowed$1 = true;
            ...
            case 66 /* UpperB */:
                {
                    ...
                    while (this.hasNext()) {
                        ...
                        if (ch === 95 /* Underscore */) {
                            state |= 256 /* ContainsFragment */;
                            separatorAllowed$2 = this$1.scanNumericFragment(separatorAllowed$2);
                            continue;
                        }
                        separatorAllowed$2 = true;
                        if (ch < 48 /* Zero */ || 57 /* Nine */ < ch)
                            { break; }
                        if (!(ch === 48 /* Zero */ || ch === 49 /* One */)) {
                            this$1.error(0 /* Unexpected */);
            ...
            case 55 /* Seven */:
                {
                    state |= 4 /* ImplicitOctal */;
                    var separatorAllowed$3 = true;
                    while (this.hasNext()) {
                        ch = this$1.nextChar();
                        if (ch === 95 /* Underscore */) {
                            state |= 256 /* ContainsFragment */;
                            this$1.flags |= 1 /* ContainsSeparator */;
                            if (separatorAllowed$3) {
                                separatorAllowed$3 = false;
                            }
                            else {
                                this$1.error(112 /* InvalidNumericSeparators */);
                            }
    ...
    if (!(state & 256 /* ContainsFragment */) && this.flags & 1 /* ContainsSeparator */) {
...
Parser.prototype.parseVariableStatement = function parseVariableStatement (context, shouldConsume) {
...
Parser.prototype.parseAssignmentExpression = function parseAssignmentExpression (context) {
    ...
    if (context & 16 /* Yield */ && this.token === 282730 /* YieldKeyword */) {
        ...
        if (context & 128 /* InParameter */ && !(this.flags & 4 /* InFunctionBody */)) {
            this.error(102 /* InvalidGeneratorParam */);
        }
    ...
    switch (params.type) {
        ...
        case 'RestElement':
            ...
            if (params.argument.type === 'AssignmentPattern')
                { this.error(113 /* InvalidRestDefaultValue */); }
            return;
        case 'MemberExpression':
        case 'MetaProperty':
            if (!(context & 512 /* InArrowParameterList */))
