...
export declare function expect(parser: Parser, context: Context, t: Token, err?: Errors): boolean;
export declare function consume(parser: Parser, context: Context, t: Token): boolean;
...
export declare function isEqualTagNames(elementName: ESTree.JSXNamespacedName | ESTree.JSXIdentifier | ESTree.JSXMemberExpression): any;
