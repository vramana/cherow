...
function qualifiedPropertyName(t) {
    switch (t) {
...
ErrorMessages[111 /* InvalidArrowYieldParam */] = 'Arrow parameters must not contain yield expressions';
...
var Parser = function Parser(source, options) {
    ...
    if (options.next)
        { this.flags |= 262144 /* OptionsNext */; }
    if (options.comments)
        { this.flags |= 1048576 /* OptionsOnComment */; }
    if (options.jsx)
        { this.flags |= 65536 /* OptionsJSX */; }
    if (options.locations)
        { this.flags |= 16384 /* OptionsLoc */; }
    if (options.ranges)
        { this.flags |= 8192 /* OptionsRanges */; }
    if (options.raw)
        { this.flags |= 131072 /* OptionsRaw */; }
    if (options.directives)
        { this.flags |= 524288 /* OptionsDirectives */; }
    if (options.v8)
        { this.flags |= 4194304 /* OptionsV8 */; }
    if (this.flags & 1048576 /* OptionsOnComment */)
...
Parser.prototype.parseModule = function parseModule (context) {
    var node = {
        type: 'Program',
        body: this.parseModuleItemList(context | 4 /* AllowIn */),
        sourceType: 'module'
    };
    if (this.flags & 8192 /* OptionsRanges */) {
        node.start = 0;
        node.end = this.source.length;
    }
    if (this.flags & 16384 /* OptionsLoc */) {
        node.loc = {
            start: {
                line: 1,
                column: 0,
...
Parser.prototype.parseScript = function parseScript (context) {
    ...
    var node = {
        type: 'Program',
        body: this.parseStatementList(context, 0 /* EndOfSource */),
        sourceType: 'script'
    };
    if (this.flags & 8192 /* OptionsRanges */) {
        node.start = 0;
            ...
            case 60 /* LessThan */:
                {
                    ...
                    if (this$1.flags & 65536 /* OptionsJSX */ &&
...
Parser.prototype.skipComments = function skipComments (state) {
    ...
    if (state & 6 /* Collectable */ && this.flags & 1048576 /* OptionsOnComment */) {
...
Parser.prototype.scanNumberLiteral = function scanNumberLiteral (context) {
    ...
    if (!(this.flags & 2048 /* Noctal */))
        { this.flags |= 2048 /* Noctal */; }
    this.advance();
    ...
    if (this.flags & 262144 /* OptionsNext */ && this.consume(110 /* LowerN */))
        { this.flags |= 4096 /* BigInt */; }
    if (this.flags & 131072 /* OptionsRaw */)
...
Parser.prototype.scanNumber = function scanNumber (context) {
    ...
    if (!(cp >= 48 /* Zero */ && cp <= 57 /* Nine */)) {
        switch (cp) {
            ...
            case 110 /* LowerN */:
                if (this.flags & 262144 /* OptionsNext */) {
                    if (state & 2 /* Float */)
...
Parser.prototype.scanRegularExpression = function scanRegularExpression () {
    ...
    loop: while (this.hasNext()) {
        ...
        switch (code) {
            ...
            // Stage 3 proposal
            case 115 /* LowerS */:
                if (this$1.flags & 262144 /* OptionsNext */) {
                    if (mask & 32 /* DotAll */)
...
Parser.prototype.scanString = function scanString (context, quote // Either double or single quote
    ...
    this.tokenValue = ret;
    // raw
    if (this.flags & (131072 /* OptionsRaw */ | 524288 /* OptionsDirectives */))
...
Parser.prototype.peekExtendedUnicodeEscape = function peekExtendedUnicodeEscape () {
    ...
    if (ch === 123 /* LeftBrace */) {
        var code = 0;
        ch = this.readNext(62 /* InvalidHexEscapeSequence */);
...
Parser.prototype.scanStringEscape = function scanStringEscape (context) {
    var cp = this.readNext(62 /* InvalidHexEscapeSequence */);
    switch (cp) {
        case 98 /* LowerB */:
            return '\b';
        case 116 /* LowerT */:
...
Parser.prototype.scanTemplate = function scanTemplate (context) {
    ...
    var tail = true;
    var ret = '';
    var ch = this.readNext(85 /* UnterminatedTemplate */);
...
Parser.prototype.parseDirective = function parseDirective (context) {
    var pos = this.startNode();
    if (this.flags & 524288 /* OptionsDirectives */) {
...
Parser.prototype.parseStatementList = function parseStatementList (context, endToken) {
    ...
    if (!(context & 2 /* Strict */)) {
        while (this.token !== endToken) {
            ...
            if (!isDirective(item))
                { break; }
            if (this$1.flags & 1024 /* HasStrictDirective */) {
                if (context & 1024 /* SimpleParameterList */)
                    { this$1.error(0 /* Unexpected */); }
...
Parser.prototype.startNode = function startNode () {
    ...
    if (!(this.flags & 24576 /* LocationTracking */))
        { return undefined; }
...
Parser.prototype.parseExportDeclaration = function parseExportDeclaration (context) {
    ...
    switch (this.token) {
        ...
        case 8663113 /* ConstKeyword */:
            declaration = this.parseVariableStatement(context |= (16777216 /* Const */ | 2097152 /* RequireInitializer */));
            break;
        // export LexicalDeclaration
        case 8671304 /* LetKeyword */:
            declaration = this.parseVariableStatement(context |= (8388608 /* Let */ | 2097152 /* RequireInitializer */));
            break;
        // export VariableDeclaration
        case 8663111 /* VarKeyword */:
            declaration = this.parseVariableStatement(context | 2097152 /* RequireInitializer */ | 16384 /* Export */);
            break;
...
Parser.prototype.parseModuleItem = function parseModuleItem (context) {
    ...
    switch (this.token) {
        ...
        case 274521 /* ImportKeyword */:
            if (!(this.flags & 262144 /* OptionsNext */ && this.nextTokenIsLeftParenOrPeriod(context))) {
...
Parser.prototype.parseStatement = function parseStatement (context) {
    switch (this.token) {
        ...
        case 274525 /* SwitchKeyword */:
            return this.parseSwitchStatement(context | 512 /* Statement */);
        ...
        case 69740 /* AsyncKeyword */:
            ...
            if (this.nextTokenIsFuncKeywordOnSameLine(context)) {
                ...
                if (context & 512 /* Statement */ || this.flags & 16 /* Break */)
                    { this.error(0 /* Unexpected */); }
                return this.parseFunctionDeclaration(context);
            }
            ...
            return this.parseLabelledStatement(context | 512 /* Statement */);
        default:
            return this.parseExpressionStatement(context);
    }
};
...
Parser.prototype.parseCatchClause = function parseCatchClause (context) {
    ...
    this.blockScope = undefined;
    var param = null;
    if (!(this.flags & 262144 /* OptionsNext */) || this.token === 262155 /* LeftParen */) {
...
Parser.prototype.parseIfStatementChild = function parseIfStatementChild (context) {
    ...
    return this.parseStatement(context | 512 /* Statement */);
};
    ...
    if (this.token !== 17 /* Semicolon */) {
        if (hasMask(this.token, 8650752 /* VarDeclStart */)) {
            ...
            if (this.parseOptional(context, 8663111 /* VarKeyword */)) {
                state |= 1 /* Var */;
                declarations = this.parseVariableDeclarationList(context | 4194304 /* ForStatement */);
            }
            else if (this.parseOptional(context, 8671304 /* LetKeyword */)) {
                state |= 4 /* Let */;
                declarations = this.parseVariableDeclarationList(context | (8388608 /* Let */ | 4194304 /* ForStatement */));
            }
            else if (this.parseOptional(context, 8663113 /* ConstKeyword */)) {
                state |= 2 /* Const */;
                declarations = this.parseVariableDeclarationList(context | (16777216 /* Const */ | 4194304 /* ForStatement */));
            }
            ...
            init = this.parseExpression(context & ~4 /* AllowIn */ | 4194304 /* ForStatement */, pos);
        }
    }
    this.flags = savedFlag;
    switch (this.token) {
        ...
        case 2111281 /* InKeyword */:
            if (state & 7 /* Variable */) {
                ...
                this.reinterpretAsPattern(context | 4194304 /* ForStatement */, init);
            }
            if (state & 8 /* Await */)
...
Parser.prototype.parseFunctionDeclaration = function parseFunctionDeclaration (context) {
    ...
    if (this.token === 2099763 /* Multiply */) {
        ...
        if (context & 32 /* Await */ && !(this.flags & 262144 /* OptionsNext */))
    ...
    if (this.token !== 262155 /* LeftParen */) {
        ...
        if (context & 1048576 /* AsyncFunctionBody */) {
            if (this.token === 331885 /* AwaitKeyword */)
                { this.error(1 /* UnexpectedToken */, tokenDesc(this.token)); }
            if (!(context & 32 /* Await */))
                { context &= ~1048576 /* AsyncFunctionBody */; }
        }
        if (context & 512 /* Statement */ && !(context & 4096 /* AnnexB */)) {
    ...
    var params = this.parseParameterList(context & ~(512 /* Statement */ | 65536 /* OptionalIdentifier */) | 128 /* InParameter */, 0 /* None */);
...
Parser.prototype.parseVariableDeclaration = function parseVariableDeclaration (context) {
    ...
    if (context & 2097152 /* RequireInitializer */ && this.token !== 1310749 /* Assign */ && id.type === 'Identifier') {
    ...
    if (context & 25165824 /* Lexical */) {
        ...
        else if (this.token === 1310749 /* Assign */ || (!(context & 4194304 /* ForStatement */) && id.type !== 'Identifier')) {
    ...
    if (this.token === 10 /* Arrow */ && (this.isIdentifier(context | 8 /* SimpleArrow */, token))) {
        if (!(this.flags & 1 /* LineTerminator */)) {
            ...
            if (hasMask(token, 20480 /* FutureReserved */)) {
                ...
                this.flags |= 512 /* BindingPosition */;
            }
...
Parser.prototype.reinterpretAsPattern = function reinterpretAsPattern (context, params) {
    ...
    switch (params.type) {
        case 'Identifier':
            if (context & 256 /* ArrowParameterList */) {
                if (context & 32 /* Await */) {
        ...
        case 'SpreadElement':
            ...
            if (context & 4194304 /* ForStatement */ && params.argument.type === 'AssignmentExpression') {
                this.error(36 /* InvalidLHSInForIn */);
            }
        // Fall through
        case 'RestElement':
...
Parser.prototype.parseArrowFormalList = function parseArrowFormalList (context, params) {
    ...
    for (var i in params)
        { this$1.reinterpretAsPattern(context | 256 /* ArrowParameterList */, params[i]); }
    return params;
};
Parser.prototype.parseArrowFunction = function parseArrowFunction (context, pos, params) {
    ...
    if (this.flags & 4 /* InFunctionBody */ && !(context & 512 /* Statement */))
        { context &= ~32 /* Await */; }
    var savedScope = this.enterFunctionScope();
    if (!(context & 8 /* SimpleArrow */))
    ...
    if (this.token === 393228 /* LeftBrace */) {
        ...
        body = this.parseConciseBody(context | 4 /* AllowIn */);
        expression = true;
    }
    this.exitFunctionScope(savedScope);
    return this.finishNode(pos, {
...
Parser.prototype.parseConciseBody = function parseConciseBody (context) {
    return this.parseAssignmentExpression(context | 4 /* AllowIn */);
};
...
Parser.prototype.parseUpdateExpression = function parseUpdateExpression (context, pos) {
    ...
    if (this.flags & 65536 /* OptionsJSX */ && this.token === 2361151 /* LessThan */) {
...
Parser.prototype.parseAsyncFunctionExpression = function parseAsyncFunctionExpression (context, pos) {
    ...
    switch (this.token) {
        ...
        case 262155 /* LeftParen */:
            ...
            return this.parseAsyncArguments(context | 1024 /* SimpleParameterList */, pos, id, flags, isEscaped);
        default:
            // Async as Identifier
            return id;
    }
...
Parser.prototype.parseAsyncArguments = function parseAsyncArguments (context, pos, id, flags, isEscaped) {
    ...
    while (this.token !== 16 /* RightParen */) {
        if (this$1.token === 14 /* Ellipsis */) {
            ...
            args.push(this$1.parseAssignmentExpression(context));
        }
        if (this$1.token === 16 /* RightParen */)
            { break; }
        this$1.expect(context, 18 /* Comma */);
    ...
    if (this.token === 10 /* Arrow */) {
        ...
        if (state & 8 /* Parenthesized */)
            { this.error(76 /* InvalidParenthesizedPattern */); }
        if (state & 4 /* Await */)
            { this.error(1 /* UnexpectedToken */, tokenDesc(this.token)); }
        // Invalid: 'async[LineTerminator here] () => {}'
        if (this.flags & 1 /* LineTerminator */)
            { this.error(73 /* LineBreakAfterAsync */); }
        return this.parseArrowFunction(context | (32 /* Await */ | 1024 /* SimpleParameterList */), pos, args);
    }
    return this.finishNode(pos, {
        type: 'CallExpression',
        callee: id,
...
Parser.prototype.parsePrimaryExpression = function parsePrimaryExpression (context, pos) {
    switch (this.token) {
        ...
        case 331885 /* AwaitKeyword */:
            ...
            return this.parseIdentifier(context);
        case 12369 /* DoKeyword */:
            if (this.flags & 4194304 /* OptionsV8 */)
...
Parser.prototype.parseClassElement = function parseClassElement (context, state) {
    ...
    if (!(state & 1 /* Yield */)) {
        ...
        if (token === 20585 /* StaticKeyword */ && (qualifiedPropertyName(this.token) || this.token === 2099763 /* Multiply */)) {
            token = this.token;
            state |= 512 /* Static */;
            if (this.parseOptional(context, 2099763 /* Multiply */)) {
                state |= 1 /* Yield */;
        ...
        if (!(this.flags & 1 /* LineTerminator */) && (token === 69740 /* AsyncKeyword */)) {
            if (this.token !== 21 /* Colon */ && this.token !== 262155 /* LeftParen */) {
                state |= 2 /* Async */;
                token = this.token;
                if (!(this.flags & 262144 /* OptionsNext */) && this.token === 2099763 /* Multiply */) {
                    this.error(108 /* InvalidAsyncGenerator */);
                }
                // Async generator
                if (this.parseOptional(context, 2099763 /* Multiply */))
...
Parser.prototype.parseObjectElement = function parseObjectElement (context) {
    ...
    if (this.isIdentifier(context & ~2 /* Strict */, token)) {
        ...
        if (this.token === 393235 /* LeftBracket */)
            { state |= 4 /* Computed */; }
        if (!(this.flags & 1 /* LineTerminator */) && (token === 69740 /* AsyncKeyword */) && isAsync(this.token)) {
            state |= 2 /* Async */;
            // Asynchronous Iteration - Stage 3 proposal
            if (!(this.flags & 262144 /* OptionsNext */) && this.token === 2099763 /* Multiply */)
                { this.error(108 /* InvalidAsyncGenerator */); }
    ...
    if (qualifiedPropertyName(this.token)) {
        ...
        switch (this.token) {
            ...
            case 21 /* Colon */:
                ...
                if (!(state & 4 /* Computed */) && tokenValue === '__proto__') {
                    if (this.flags & 128 /* HasPrototype */)
                        { this.error(60 /* DuplicateProtoProperty */); }
                    this.flags |= 128 /* HasPrototype */;
                }
                this.expect(context, 21 /* Colon */);
...
Parser.prototype.parseMethodDefinition = function parseMethodDefinition (context, state) {
    ...
    if (state & 32 /* Set */) {
        if (params[0].type === 'RestElement') {
            this.error(26 /* BadSetterRestParameter */);
        }
    }
    var body = this.parseFunctionBody(context);
    this.flags = savedFlag;
...
Parser.prototype.parseParenthesizedExpression = function parseParenthesizedExpression (context) {
    ...
    var pos = this.startNode();
    this.expect(context, 262155 /* LeftParen */);
    if (context & 4194304 /* ForStatement */ && hasMask(this.token, 131072 /* BindingPattern */)) {
        this.error(35 /* InvalidLHSInForLoop */);
    }
    var state = 0;
    if (this.parseOptional(context, 16 /* RightParen */)) {
        if (this.token === 10 /* Arrow */)
            { return this.parseArrowFunction(context & ~(32 /* Await */ | 16 /* Yield */ | 4194304 /* ForStatement */), pos, []); }
    ...
    if (this.token === 14 /* Ellipsis */) {
        ...
        this.expect(context, 16 /* RightParen */);
        return this.parseArrowFunction(context & ~(32 /* Await */ | 4194304 /* ForStatement */), pos, [expr]);
    }
    ...
    if (this.token === 18 /* Comma */) {
        ...
        while (this.parseOptional(context, 18 /* Comma */)) {
            if (this$1.parseOptional(context, 16 /* RightParen */)) {
                return this$1.parseArrowFunction(context & ~(32 /* Await */ | 4194304 /* ForStatement */), pos, expressions);
            }
            else if (this$1.token === 14 /* Ellipsis */) {
                ...
                expressions.push(this$1.parseAssignmentExpression(context & ~4194304 /* ForStatement */));
            }
        }
    ...
    if (this.token === 10 /* Arrow */) {
        if (this.flags & 256 /* HaveSeenYield */)
            { this.error(111 /* InvalidArrowYieldParam */); }
        if (state & 1 /* EvalOrArg */)
            { this.error(90 /* StrictParamName */); }
        if (state & 8 /* Parenthesized */)
            { this.error(76 /* InvalidParenthesizedPattern */); }
...
Parser.prototype.parseLiteral = function parseLiteral (context) {
    ...
    var raw = this.tokenRaw;
    if (value === 'use strict')
        { this.flags |= 1024 /* HasStrictDirective */; }
    if (context & 2 /* Strict */ && this.flags & 2048 /* Noctal */) {
        this.error(0 /* Unexpected */);
    }
    this.nextToken(context);
    var node = this.finishNode(pos, {
...
Parser.prototype.parseAssignmentElementList = function parseAssignmentElementList (context) {
    ...
    while (this.token !== 20 /* RightBracket */) {
        if (this$1.parseOptional(context, 18 /* Comma */)) {
            ...
            elements.push(this$1.parseArrayAssignmentPattern(context | 4 /* AllowIn */));
            if (this$1.token !== 20 /* RightBracket */)
                { this$1.expect(context, 18 /* Comma */); }
        }
    }
