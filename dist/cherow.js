...
ErrorMessages[91 /* InvalidStrictLexical */] = 'The identifier \'let\' must not be in binding position in strict mode';
...
var Parser = function Parser(source, options) {
    ...
    if (options.comments)
        { this.flags |= 16777216 /* OptionsComments */; }
    if (options.jsx)
        { this.flags |= 1048576 /* OptionsJSX */; }
    if (options.locations)
        { this.flags |= 262144 /* OptionsLoc */; }
    if (options.source)
        { this.flags |= 524288 /* OptionsSource */; }
    if (options.ranges)
    ...
    if (options.directives)
        { this.flags |= 8388608 /* OptionsDirectives */; }
    if (options.v8)
        { this.flags |= 67108864 /* OptionsV8 */; }
    if (this.flags & 16777216 /* OptionsComments */)
        { this.comments = options.comments; }
    if (this.flags & (262144 /* OptionsLoc */ | 524288 /* OptionsSource */))
...
Parser.prototype.scanToken = function scanToken (context) {
    ...
    if (!(context & 2 /* Strict */) && this.flags & 4096 /* HasStrictDirective */) {
        context |= 2 /* Strict */;
    }
...
Parser.prototype.skipComments = function skipComments (state) {
    ...
    if (state & 24 /* Collectable */ && this.flags & 16777216 /* OptionsComments */) {
        var loc = {};
...
Parser.prototype.scanNumberLiteral = function scanNumberLiteral (context) {
    ...
    if (this.flags & 4194304 /* OptionsNext */ && this.consume(110 /* LowerN */))
        ...
        switch (ch) {
            ...
            case 92 /* Backslash */:
                ...
                if (ch >= 128) {
                    ...
                    else if (code !== -1 /* Empty */ && context & 2097152 /* TaggedTemplate */) {
                        ret = null;
...
Parser.prototype.parseStatementList = function parseStatementList (context, endToken) {
    ...
    while (this.token === 262147 /* StringLiteral */) {
        ...
        if (!isPrologueDirective(item))
            { break; }
        if (this$1.flags & 4096 /* HasStrictDirective */) {
            if (this$1.flags & 16384 /* SimpleParameterList */)
                { this$1.error(26 /* IllegalUseStrict */); }
            if (this$1.flags & 2048 /* BindingPosition */)
...
Parser.prototype.finishNode = function finishNode (loc, node) {
    ...
    if (this.flags & 262144 /* OptionsLoc */) {
        ...
        if (this.flags & 524288 /* OptionsSource */) {
...
Parser.prototype.isIdentifier = function isIdentifier (context, t) {
    if (context & 2 /* Strict */) {
        if (t === 8671304 /* LetKeyword */)
            { this.error(91 /* InvalidStrictLexical */); }
        if (context & 1 /* Module */) {
...
Parser.prototype.parseModuleItem = function parseModuleItem (context) {
    ...
    switch (this.token) {
        ...
        case 274521 /* ImportKeyword */:
            if (!(this.flags & 4194304 /* OptionsNext */ && this.nextTokenIsLeftParenOrPeriod(context))) {
...
Parser.prototype.parseWithStatement = function parseWithStatement (context) {
    ...
    return this.finishNode(pos, {
        type: 'WithStatement',
        object: object,
        body: this.parseStatement(context & ~1024 /* TopLevel */ | 8388608 /* Iteration */)
    });
};
...
Parser.prototype.parseContinueStatement = function parseContinueStatement (context) {
    var pos = this.getLocations();
    if (context & 4194304 /* Labelled */ && !(this.flags & 32 /* Iteration */))
...
Parser.prototype.parseIfStatementChild = function parseIfStatementChild (context) {
    ...
    return this.parseStatement(context | (4096 /* AnnexB */ | 1024 /* TopLevel */ | 8388608 /* Iteration */));
};
...
Parser.prototype.parseFunctionDeclaration = function parseFunctionDeclaration (context) {
    ...
    var savedScope = this.enterFunctionScope();
    var params = this.parseParameterList(context & ~(1024 /* TopLevel */ | 65536 /* OptionalIdentifier */) | 128 /* InParameter */, 0 /* None */);
...
Parser.prototype.parseLabelledStatement = function parseLabelledStatement (context) {
    ...
    if (this.token === 21 /* Colon */ && expr.type === 'Identifier') {
        ...
        switch (this.token) {
            case 274519 /* FunctionKeyword */:
                if (context & 8388608 /* Iteration */)
                    { this.error(113 /* InvalidWithBody */); }
                if (context & 1048576 /* ForStatement */ || this.flags & 32 /* Iteration */)
                ...
                body = this.parseFunctionDeclaration(context & ~8388608 /* Iteration */ | 4096 /* AnnexB */ | 1024 /* TopLevel */);
                break;
            default:
                body = this.parseStatement(context | 1024 /* TopLevel */ | 4194304 /* Labelled */);
        }
...
Parser.prototype.parseVariableDeclaration = function parseVariableDeclaration (context) {
    ...
    if (hasMask(token, 131072 /* BindingPattern */)) {
        if (this.parseEventually(context, 1310749 /* Assign */)) {
            init = this.parseAssignmentExpression(context & ~(402653184 /* Lexical */ | 1048576 /* ForStatement */));
            if (!(context & 402653184 /* Lexical */) && context & 1048576 /* ForStatement */) {
        ...
        else if (!(context & 1048576 /* ForStatement */)) {
            this.error(31 /* DeclarationMissingInitializer */);
        }
    }
    else {
...
Parser.prototype.parseAssignmentExpression = function parseAssignmentExpression (context) {
    ...
    if (hasMask(this.token, 1310720 /* AssignOperator */)) {
        ...
        if (context & 2 /* Strict */ && this.isEvalOrArguments(expr.name)) {
            ...
            if (this.flags & 1024 /* HaveSeenRest */)
    ...
    switch (params.type) {
        ...
        case 'ObjectPattern':
            ...
            for (var i = 0; i < params.properties.length; i++) {
                ...
                if (!(context & 1048576 /* ForStatement */) && property.kind !== 'init')
        ...
        case 'SpreadElement':
            ...
            if (context & 1048576 /* ForStatement */ && params.argument.type === 'AssignmentExpression') {
            ...
            case 13 /* Period */:
                {
                    ...
                    if (context & 1048576 /* ForStatement */ && this$1.token === 69746 /* OfKeyword */) {
            ...
            case 262153 /* TemplateTail */:
                {
                    ...
                    var quasi = this$1.token === 262152 /* TemplateCont */ ?
                        this$1.parseTemplate(context | 2097152 /* TaggedTemplate */, quasiPos) : this$1.parseTemplateTail(context | 2097152 /* TaggedTemplate */, quasiPos);
...
Parser.prototype.parsePrimaryExpression = function parsePrimaryExpression (context, pos) {
    switch (this.token) {
        ...
        case 2361151 /* LessThan */:
            if (this.flags & 1048576 /* OptionsJSX */)
                { return this.parseJSXElement(context | 16384 /* JSXChild */); }
        case 117 /* Hash */:
            if (context & 131072 /* Method */)
...
Parser.prototype.parseClassElement = function parseClassElement (context, state) {
    ...
    if (this.token === 2099763 /* Multiply */) {
        if (state & 2 /* Async */ && !(this.flags & 4194304 /* OptionsNext */)) {
            this.error(102 /* InvalidAsyncGenerator */);
        }
    ...
    value = this.parseMethodDefinition(context & ~(16 /* Yield */ | 32 /* Await */) | 131072 /* Method */, state);
    return this.finishNode(pos, {
...
Parser.prototype.parseObjectElement = function parseObjectElement (context) {
    ...
    switch (this.token) {
        ...
        default:
            ...
            if (context & (1048576 /* ForStatement */ | 64 /* InParenthesis */) &&
                context & 2 /* Strict */ && this.isEvalOrArguments(tokenValue)) {
                this.error(78 /* UnexpectedReservedWord */);
            }
            state |= 8 /* Shorthand */;
            if (this.token === 1310749 /* Assign */) {
                if (context & 8192 /* Assignment */) {
                    this.error(80 /* InvalidShorthandAssignment */);
                }
    ...
    while (this.token !== 20 /* RightBracket */) {
        if (this$1.parseEventually(context, 18 /* Comma */)) {
            ...
            if (this$1.token !== 20 /* RightBracket */) {
                this$1.errorLocation = this$1.getLocations();
                this$1.flags |= 1024 /* HaveSeenRest */;
                this$1.expect(context, 18 /* Comma */);
            }
            ...
            if (context & 16 /* Yield */ && !(context & 131072 /* Method */) &&
...
Parser.prototype.parseLiteral = function parseLiteral (context) {
    ...
    var value = this.tokenValue;
    var raw = this.tokenRaw;
    if (value === 'use strict' && !(this.flags & (2 /* HasUnicode */ | 4096 /* HasStrictDirective */))) {
        this.flags |= 4096 /* HasStrictDirective */;
    }
    this.nextToken(context);
    var node = this.finishNode(pos, {
        type: 'Literal',
...
Parser.prototype.parseBindingIdentifier = function parseBindingIdentifier (context) {
    ...
    if (context & 128 /* InParameter */ && context & (2 /* Strict */ | 32 /* Await */ | 67108864 /* Pattern */)) {
...
Parser.prototype.parseJSXChildren = function parseJSXChildren (context) {
    ...
    while (this.token !== 25 /* JSXClose */) {
        children.push(this$1.parseJSXChild(context | 16384 /* JSXChild */, this$1.getLocations()));
    }
    return children;
};
    ...
    loop: while (this.hasNext()) {
        switch (this$1.token) {
            ...
            case 2099008 /* GreaterThan */:
                break loop;
            case 393228 /* LeftBrace */:
                attributes.push(this$1.parseJSXSpreadAttribute(context &= ~16384 /* JSXChild */));
                break;
            default:
...
Parser.prototype.parseJSXElementName = function parseJSXElementName (context) {
    ...
    var expression = this.parseJSXIdentifier(context | 16384 /* JSXChild */);
    // Namespace
    if (this.token === 21 /* Colon */)
